...
- [ ] Fases backend restantes (spec `docs/superpowers/specs/2026-06-26-sp3-modal-unificado-spec.md`): A1 estados-cuentas, B1 3DS, B2 analyzer A+/inteligencia BIN, B3 matchmaker rework, B4 paralelismo.
