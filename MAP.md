...
|--------|----|---------|-----------| 
| `app.py` | 2470 | `betmexico.dashboard.sse` | App Flask principal: config, BD SQLite, rutas base, bus SSE, KPIs/admin, watchdog init |
...
| `test_a1_estados.py` | 206 | `—` | _[completar]_ |
