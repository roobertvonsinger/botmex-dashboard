...
| `get_logs` | def | L1531–L1566 |
| `_run_health_checks` | def | L1574–L1610 |
| `health_full` | def | L1614–L1615 |
| `_require_sa` | def | L1623–L1625 |
| `admin_diag` | def | L1629–L1660 |
| `admin_ping` | def | L1664–L1685 |
| `admin_refresh_proxy` | def | L1689–L1696 |
| `admin_services_restart` | def | L1700–L1714 |
| `admin_export_logs` | def | L1718–L1730 |
| `admin_pause_state` | def | L1738–L1740 |
| `admin_pause` | def | L1744–L1756 |
| `admin_resume` | def | L1760–L1766 |
| `admin_emergency_stop` | def | L1770–L1805 |
| `admin_vps_reboot` | def | L1809–L1821 |
| `health_last` | def | L1825–L1826 |
| `health_dismiss` | def | L1830–L1833 |
| `api_marks_list` | def | L1837–L1844 |
| `api_marks_toggle` | def | L1848–L1866 |
| `api_recent` | def | L1870–L1942 |
| `api_accounts_at_hand` | def | L1946–L2054 |
| `_health_loop` | def | L2057–L2067 |
| `_release_account` | def | L2070–L2091 |
| `_run_lock_janitor` | def | L2094–L2142 |
| `_janitor_loop` | def | L2145–L2155 |
| `_run_window_watcher` | def | L2164–L2236 |
| `_window_watcher_loop` | def | L2239–L2248 |
| `_release_watchdog_tick` | def | L2251–L2350 |
| `_release_watchdog_loop` | def | L2353–L2361 |
| `_jwt_keepalive_loop` | def | L2364–L2381 |
| `_account_refresh_loop` | def | L2384–L2402 |
| `_start_bg_tasks` | def | L2406–L2412 |
| `LockRequest` | class | L2415–L2417 |
| `lock_account` | def | L2421–L2460 |
| `PublishRequest` | class | L2463–L2465 |
| `publish_accounts` | def | L2469–L2498 |
| `hide_all_accounts` | def | L2502–L2517 |
| `pool_accounts` | def | L2521–L2539 |
| `api_pool_split` | def | L2543–L2557 |
| `api_pool_publish` | def | L2561–L2595 |
| `unlock_account` | def | L2599–L2617 |
| `_sse_generator` | def | L2620–L2646 |
| `events` | def | L2650–L2660 |
| `account_cards_pipe` | def | L2664–L2690 |
| `account_notes_summary` | def | L2694–L2719 |
| `_record_account_touch` | def | L2722–L2755 |
| `account_details` | def | L2759–L3083 |
| `NoteCreate` | class | L3086–L3087 |
| `create_note` | def | L3091–L3120 |
| `CurpUpdate` | class | L3123–L3124 |
| `update_curp` | def | L3128–L3139 |
| `get_clabes` | def | L3149–L3158 |
| `refresh_clabes` | def | L3162–L3172 |
| `_persist_withdrawal` | def | L3181–L3227 |
| `withdraw` | def | L3231–L3276 |
| `withdraw_status` | def | L3280–L3437 |
| `delete_note` | def | L3441–L3453 |
| `CombosRequest` | class | L3456–L3457 |
| `accounts_combos` | def | L3461–L3474 |
| `accounts_pass_map` | def | L3478–L3483 |
| `list_all_cards` | def | L3487–L3562 |
| `activity_feed` | def | L3566–L3663 |
| `list_deposits` | def | L3667–L3696 |
| `deposits_stats` | def | L3700–L3725 |
