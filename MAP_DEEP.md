...
|---------|------|--------|
| `db` | def | L124–L138 |
| `_migrate` | def | L141–L278 |
| `_backfill_grades_v10_m7` | def | L281–L352 |
| `_resolve_operator` | def | L358–L382 |
| `_is_sa` | def | L385–L387 |
| `_visible_emails` | def | L390–L412 |
| `_broadcast` | def | L419–L437 |
| `_dequeue_blocking` | def | L440–L445 |
| `_no_cache_static_assets` | def | L453–L465 |
| `favicon` | def | L473–L474 |
| `login_page` | def | L478–L481 |
| `_asset_mtimes` | def | L497–L504 |
| `_frontend_version` | def | L507–L511 |
| `index` | def | L515–L539 |
| `api_version` | def | L543–L553 |
| `auth_login` | def | L562–L593 |
| `auth_set_password` | def | L597–L621 |
| `auth_logout` | def | L625–L629 |
| `auth_me` | def | L633–L638 |
| `health` | def | L644–L650 |
| `_build_search_clause` | def | L653–L697 |
| `list_accounts` | def | L701–L817 |
| `list_users` | def | L823–L831 |
| `list_assignments` | def | L835–L856 |
| `AssignRequest` | class | L859–L861 |
| `assign_accounts` | def | L865–L884 |
| `unassign_accounts` | def | L888–L899 |
| `stats` | def | L903–L910 |
| `_wsai_status` | def | L925–L950 |
| `_maybe_alert_broadcast` | def | L957–L974 |
| `_check_one_proxy` | def | L977–L1003 |
| `_proxy_health` | def | L1006–L1055 |
| `_capmonster_balance` | def | L1058–L1078 |
| `_operator_color` | def | L1083–L1098 |
| `_resolve_who` | def | L1101–L1114 |
| `_event_visible_to` | def | L1117–L1143 |
| `superadmin_kpis` | def | L1147–L1390 |
| `RefreshRequest` | class | L1395–L1396 |
| `accounts_refresh` | def | L1400–L1419 |
| `get_logs` | def | L1425–L1450 |
| `_run_health_checks` | def | L1458–L1494 |
| `health_full` | def | L1498–L1499 |
| `_require_sa` | def | L1507–L1509 |
| `admin_diag` | def | L1513–L1544 |
| `admin_ping` | def | L1548–L1569 |
| `admin_refresh_proxy` | def | L1573–L1580 |
| `admin_services_restart` | def | L1584–L1598 |
| `admin_export_logs` | def | L1602–L1614 |
| `admin_pause_state` | def | L1622–L1624 |
| `admin_pause` | def | L1628–L1640 |
| `admin_resume` | def | L1644–L1650 |
| `admin_emergency_stop` | def | L1654–L1689 |
| `admin_vps_reboot` | def | L1693–L1705 |
| `health_last` | def | L1709–L1710 |
| `health_dismiss` | def | L1714–L1717 |
| `api_marks_list` | def | L1721–L1728 |
| `api_marks_toggle` | def | L1732–L1750 |
| `api_recent` | def | L1754–L1826 |
| `api_accounts_at_hand` | def | L1830–L1938 |
| `_health_loop` | def | L1941–L1951 |
| `_release_account` | def | L1954–L1975 |
| `_run_lock_janitor` | def | L1978–L2026 |
| `_janitor_loop` | def | L2029–L2039 |
| `_run_window_watcher` | def | L2048–L2120 |
| `_window_watcher_loop` | def | L2123–L2132 |
| `_release_watchdog_tick` | def | L2135–L2234 |
| `_release_watchdog_loop` | def | L2237–L2245 |
| `_jwt_keepalive_loop` | def | L2248–L2265 |
| `_account_refresh_loop` | def | L2268–L2286 |
| `_start_bg_tasks` | def | L2290–L2296 |
| `LockRequest` | class | L2299–L2301 |
| `lock_account` | def | L2305–L2344 |
| `PublishRequest` | class | L2347–L2349 |
| `publish_accounts` | def | L2353–L2382 |
| `hide_all_accounts` | def | L2386–L2401 |
| `pool_accounts` | def | L2405–L2423 |
| `api_pool_split` | def | L2427–L2441 |
| `api_pool_publish` | def | L2445–L2479 |
| `unlock_account` | def | L2483–L2501 |
| `_sse_generator` | def | L2504–L2530 |
| `events` | def | L2534–L2544 |
| `account_cards_pipe` | def | L2548–L2574 |
| `account_notes_summary` | def | L2578–L2603 |
| `account_details` | def | L2607–L2923 |
| `NoteCreate` | class | L2926–L2927 |
| `create_note` | def | L2931–L2960 |
| `CurpUpdate` | class | L2963–L2964 |
| `update_curp` | def | L2968–L2979 |
| `get_clabes` | def | L2989–L2998 |
| `refresh_clabes` | def | L3002–L3012 |
| `delete_note` | def | L3016–L3028 |
| `CombosRequest` | class | L3031–L3032 |
| `accounts_combos` | def | L3036–L3049 |
| `accounts_pass_map` | def | L3053–L3058 |
| `list_all_cards` | def | L3062–L3137 |
| `activity_feed` | def | L3141–L3262 |
| `list_deposits` | def | L3266–L3295 |
| `deposits_stats` | def | L3299–L3324 |
