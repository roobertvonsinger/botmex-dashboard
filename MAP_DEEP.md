...
| `_is_maintenance_active` | def | L597–L600 |
| `_maintenance_gate_middleware` | def | L603–L628 |
| `_no_cache_static_assets` | def | L632–L644 |
| `favicon` | def | L652–L653 |
| `maintenance_page` | def | L657–L658 |
| `login_page` | def | L662–L665 |
| `_asset_mtimes` | def | L681–L688 |
| `_frontend_version` | def | L691–L695 |
| `index` | def | L699–L723 |
| `api_version` | def | L727–L737 |
| `auth_login` | def | L746–L777 |
| `auth_set_password` | def | L781–L805 |
| `auth_logout` | def | L809–L813 |
| `auth_me` | def | L817–L822 |
| `health` | def | L828–L834 |
| `_build_search_clause` | def | L837–L881 |
| `list_accounts` | def | L885–L1005 |
| `list_users` | def | L1011–L1019 |
| `list_assignments` | def | L1023–L1044 |
| `AssignRequest` | class | L1047–L1049 |
| `assign_accounts` | def | L1053–L1072 |
| `unassign_accounts` | def | L1076–L1087 |
| `stats` | def | L1091–L1098 |
| `_wsai_status` | def | L1113–L1138 |
| `_maybe_alert_broadcast` | def | L1145–L1162 |
| `_check_one_proxy` | def | L1165–L1191 |
| `_proxy_health` | def | L1194–L1243 |
| `_capmonster_balance` | def | L1246–L1266 |
| `_operator_color` | def | L1271–L1286 |
| `_resolve_who` | def | L1289–L1302 |
| `_event_visible_to` | def | L1305–L1331 |
| `superadmin_kpis` | def | L1335–L1578 |
| `RefreshRequest` | class | L1583–L1584 |
| `accounts_refresh` | def | L1588–L1607 |
| `get_logs` | def | L1628–L1663 |
| `_run_health_checks` | def | L1671–L1707 |
| `health_full` | def | L1711–L1712 |
| `_require_sa` | def | L1720–L1722 |
| `admin_diag` | def | L1726–L1757 |
| `admin_ping` | def | L1761–L1782 |
| `admin_refresh_proxy` | def | L1786–L1793 |
| `admin_services_restart` | def | L1797–L1811 |
| `admin_export_logs` | def | L1815–L1827 |
| `admin_pause_state` | def | L1835–L1837 |
| `admin_pause` | def | L1841–L1853 |
| `admin_resume` | def | L1857–L1863 |
| `admin_emergency_stop` | def | L1867–L1902 |
| `admin_vps_reboot` | def | L1906–L1918 |
| `health_last` | def | L1922–L1923 |
| `health_dismiss` | def | L1927–L1930 |
| `api_marks_list` | def | L1934–L1941 |
| `api_marks_toggle` | def | L1945–L1963 |
| `api_recent` | def | L1967–L2039 |
| `api_accounts_at_hand` | def | L2043–L2151 |
| `_health_loop` | def | L2154–L2164 |
| `_release_account` | def | L2167–L2188 |
| `_run_lock_janitor` | def | L2191–L2239 |
| `_janitor_loop` | def | L2242–L2252 |
| `_run_window_watcher` | def | L2261–L2333 |
| `_window_watcher_loop` | def | L2336–L2345 |
| `_release_watchdog_tick` | def | L2348–L2447 |
| `_release_watchdog_loop` | def | L2450–L2458 |
| `_jwt_keepalive_loop` | def | L2461–L2478 |
| `_account_refresh_loop` | def | L2481–L2499 |
| `_start_bg_tasks` | def | L2503–L2509 |
| `LockRequest` | class | L2512–L2514 |
| `lock_account` | def | L2518–L2557 |
| `PublishRequest` | class | L2560–L2562 |
| `publish_accounts` | def | L2566–L2595 |
| `hide_all_accounts` | def | L2599–L2614 |
| `pool_accounts` | def | L2618–L2636 |
| `api_pool_split` | def | L2640–L2654 |
| `api_pool_publish` | def | L2658–L2692 |
| `unlock_account` | def | L2696–L2714 |
| `_sse_generator` | def | L2717–L2743 |
| `events` | def | L2747–L2757 |
| `account_cards_pipe` | def | L2761–L2787 |
| `account_notes_summary` | def | L2791–L2816 |
| `_record_account_touch` | def | L2819–L2852 |
| `account_details` | def | L2856–L3196 |
| `NoteCreate` | class | L3199–L3200 |
| `create_note` | def | L3204–L3233 |
| `CurpUpdate` | class | L3236–L3237 |
| `update_curp` | def | L3241–L3252 |
| `get_clabes` | def | L3262–L3271 |
| `refresh_clabes` | def | L3275–L3285 |
| `_persist_withdrawal` | def | L3294–L3340 |
| `withdraw` | def | L3344–L3389 |
| `withdraw_status` | def | L3393–L3550 |
| `delete_note` | def | L3554–L3566 |
| `CombosRequest` | class | L3569–L3570 |
| `accounts_combos` | def | L3574–L3587 |
| `accounts_pass_map` | def | L3591–L3596 |
| `list_all_cards` | def | L3600–L3675 |
| `activity_feed` | def | L3679–L3776 |
| `list_deposits` | def | L3780–L3809 |
| `deposits_stats` | def | L3813–L3838 |
| `_persist_auto_mission` | def | L3846–L3876 |
| `admin_maintenance_state` | def | L3880–L3883 |
| `MaintenanceToggleRequest` | class | L3886–L3887 |
| `admin_maintenance_toggle` | def | L3891–L3912 |
| `auto_deposit_create` | def | L3916–L3952 |
| `auto_deposit_cancel` | def | L3956–L3982 |
| `auto_deposit_status` | def | L3986–L3997 |
