...
| `get_logs` | def | L1645–L1680 |
| `_run_health_checks` | def | L1688–L1724 |
| `health_full` | def | L1728–L1729 |
| `_require_sa` | def | L1737–L1739 |
| `admin_diag` | def | L1743–L1774 |
| `admin_ping` | def | L1778–L1799 |
| `admin_refresh_proxy` | def | L1803–L1810 |
| `admin_services_restart` | def | L1814–L1828 |
| `admin_export_logs` | def | L1832–L1844 |
| `admin_pause_state` | def | L1852–L1854 |
| `admin_pause` | def | L1858–L1870 |
| `admin_resume` | def | L1874–L1880 |
| `admin_emergency_stop` | def | L1884–L1919 |
| `admin_vps_reboot` | def | L1923–L1935 |
| `health_last` | def | L1939–L1940 |
| `health_dismiss` | def | L1944–L1947 |
| `api_marks_list` | def | L1951–L1958 |
| `api_marks_toggle` | def | L1962–L1980 |
| `api_recent` | def | L1984–L2056 |
| `api_accounts_at_hand` | def | L2060–L2168 |
| `_health_loop` | def | L2171–L2181 |
| `_release_account` | def | L2184–L2205 |
| `_run_lock_janitor` | def | L2208–L2256 |
| `_janitor_loop` | def | L2259–L2269 |
| `_run_window_watcher` | def | L2278–L2350 |
| `_window_watcher_loop` | def | L2353–L2362 |
| `_release_watchdog_tick` | def | L2365–L2464 |
| `_release_watchdog_loop` | def | L2467–L2475 |
| `_jwt_keepalive_loop` | def | L2478–L2495 |
| `_account_refresh_loop` | def | L2498–L2516 |
| `_startup_telegram_notify` | def | L2519–L2541 |
| `_start_bg_tasks` | def | L2545–L2552 |
| `LockRequest` | class | L2555–L2557 |
| `lock_account` | def | L2561–L2600 |
| `PublishRequest` | class | L2603–L2605 |
| `publish_accounts` | def | L2609–L2638 |
| `hide_all_accounts` | def | L2642–L2657 |
| `pool_accounts` | def | L2661–L2679 |
| `api_pool_split` | def | L2683–L2697 |
| `api_pool_publish` | def | L2701–L2735 |
| `unlock_account` | def | L2739–L2757 |
| `_sse_generator` | def | L2760–L2786 |
| `events` | def | L2790–L2800 |
| `account_cards_pipe` | def | L2804–L2830 |
| `account_notes_summary` | def | L2834–L2859 |
| `_record_account_touch` | def | L2862–L2895 |
| `account_details` | def | L2899–L3239 |
| `NoteCreate` | class | L3242–L3243 |
| `create_note` | def | L3247–L3276 |
| `CurpUpdate` | class | L3279–L3280 |
| `update_curp` | def | L3284–L3295 |
| `get_clabes` | def | L3305–L3314 |
| `refresh_clabes` | def | L3318–L3328 |
| `_persist_withdrawal` | def | L3337–L3383 |
| `withdraw` | def | L3387–L3432 |
| `withdraw_status` | def | L3436–L3593 |
| `delete_note` | def | L3597–L3609 |
| `CombosRequest` | class | L3612–L3613 |
| `accounts_combos` | def | L3617–L3630 |
| `accounts_pass_map` | def | L3634–L3639 |
| `list_all_cards` | def | L3643–L3718 |
| `activity_feed` | def | L3722–L3819 |
| `list_deposits` | def | L3823–L3852 |
| `deposits_stats` | def | L3856–L3881 |
| `_persist_auto_mission` | def | L3889–L3919 |
| `admin_maintenance_state` | def | L3923–L3926 |
| `MaintenanceToggleRequest` | class | L3929–L3930 |
| `admin_maintenance_toggle` | def | L3934–L3955 |
| `auto_deposit_create` | def | L3959–L3995 |
| `auto_deposit_cancel` | def | L3999–L4025 |
| `auto_deposit_status` | def | L4029–L4040 |
| `register_operator_strike` | def | L4043–L4076 |
...
| `plan_auto_mission` | def | L318–L533 |
| `_iso` | def | L574–L575 |
| `_m_load` | def | L578–L585 |
| `_m_status` | def | L588–L590 |
| `_m_update` | def | L593–L602 |
| `_fetch_account` | def | L605–L611 |
| `_unlock` | def | L614–L622 |
| `_broadcast_mission` | def | L625–L634 |
| `_stop_pool` | def | L637–L644 |
| `run_auto_mission` | def | L648–L951 |
...
| `format_ruthopia_liveness_summary` | def | L220–L235 |
...
| `multi_stream` | def | L1849–L2364 |
| `multi_cancel` | def | L2368–L2373 |
| `scheduled_create` | def | L2386–L2745 |
| `scheduled_list` | def | L2749–L2771 |
| `scheduled_cancel` | def | L2775–L2783 |
