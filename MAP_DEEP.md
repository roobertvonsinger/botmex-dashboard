...
| `_proxy_health` | def | L625–L687 |
| `_capmonster_balance` | def | L690–L710 |
| `_operator_color` | def | L715–L716 |
| `_resolve_who` | def | L719–L727 |
| `superadmin_kpis` | def | L731–L974 |
| `RefreshRequest` | class | L979–L980 |
| `accounts_refresh` | def | L984–L1003 |
| `get_logs` | def | L1009–L1034 |
| `_run_health_checks` | def | L1042–L1078 |
| `health_full` | def | L1082–L1083 |
| `_require_sa` | def | L1091–L1093 |
| `admin_diag` | def | L1097–L1128 |
| `admin_ping` | def | L1132–L1153 |
| `admin_refresh_proxy` | def | L1157–L1164 |
| `admin_services_restart` | def | L1168–L1182 |
| `admin_export_logs` | def | L1186–L1198 |
| `admin_pause_state` | def | L1206–L1208 |
| `admin_pause` | def | L1212–L1224 |
| `admin_resume` | def | L1228–L1234 |
| `admin_emergency_stop` | def | L1238–L1273 |
| `admin_vps_reboot` | def | L1277–L1289 |
| `health_last` | def | L1293–L1294 |
| `health_dismiss` | def | L1298–L1301 |
| `_health_loop` | def | L1304–L1314 |
| `_run_lock_janitor` | def | L1317–L1375 |
| `_janitor_loop` | def | L1378–L1388 |
| `_run_window_watcher` | def | L1397–L1471 |
| `_window_watcher_loop` | def | L1474–L1483 |
| `_release_watchdog_tick` | def | L1486–L1602 |
| `_release_watchdog_loop` | def | L1605–L1613 |
| `_start_bg_tasks` | def | L1617–L1621 |
| `LockRequest` | class | L1624–L1626 |
| `lock_account` | def | L1630–L1658 |
| `PublishRequest` | class | L1661–L1663 |
| `publish_accounts` | def | L1667–L1682 |
| `hide_all_accounts` | def | L1686–L1697 |
| `pool_accounts` | def | L1701–L1719 |
| `unlock_account` | def | L1723–L1750 |
| `_sse_generator` | def | L1753–L1780 |
| `events` | def | L1784–L1789 |
| `account_cards_pipe` | def | L1793–L1818 |
| `account_notes_summary` | def | L1822–L1847 |
| `account_details` | def | L1851–L2055 |
| `NoteCreate` | class | L2058–L2059 |
| `create_note` | def | L2063–L2092 |
| `CurpUpdate` | class | L2095–L2096 |
| `update_curp` | def | L2100–L2111 |
| `delete_note` | def | L2115–L2127 |
| `CombosRequest` | class | L2130–L2131 |
| `accounts_combos` | def | L2135–L2144 |
| `accounts_pass_map` | def | L2148–L2152 |
| `list_all_cards` | def | L2156–L2226 |
| `activity_feed` | def | L2230–L2347 |
| `list_deposits` | def | L2351–L2376 |
| `deposits_stats` | def | L2380–L2405 |
