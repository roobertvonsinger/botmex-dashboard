...
| `list_accounts` | def | L1096–L1242 |
| `list_users` | def | L1248–L1256 |
| `list_assignments` | def | L1260–L1281 |
| `AssignRequest` | class | L1284–L1286 |
| `assign_accounts` | def | L1290–L1309 |
| `unassign_accounts` | def | L1313–L1324 |
| `stats` | def | L1328–L1335 |
| `_wsai_status` | def | L1350–L1375 |
| `_maybe_alert_broadcast` | def | L1382–L1399 |
| `_check_one_proxy` | def | L1402–L1428 |
| `_proxy_health` | def | L1431–L1480 |
| `_capmonster_balance` | def | L1483–L1503 |
| `_operator_color` | def | L1508–L1523 |
| `_resolve_who` | def | L1526–L1539 |
| `_event_visible_to` | def | L1542–L1568 |
| `superadmin_kpis` | def | L1572–L1815 |
| `RefreshRequest` | class | L1820–L1821 |
| `accounts_refresh` | def | L1825–L1844 |
| `_tail_log_file` | def | L1871–L1899 |
| `get_logs` | def | L1903–L1925 |
| `get_logs_telegram` | def | L1935–L1950 |
| `_run_health_checks` | def | L1958–L1994 |
| `health_full` | def | L1998–L1999 |
| `_require_sa` | def | L2007–L2009 |
| `admin_diag` | def | L2013–L2044 |
| `admin_ping` | def | L2048–L2069 |
| `admin_refresh_proxy` | def | L2073–L2080 |
| `admin_services_restart` | def | L2084–L2105 |
| `admin_export_logs` | def | L2109–L2125 |
| `admin_pause_state` | def | L2133–L2135 |
| `admin_pause` | def | L2139–L2151 |
| `admin_resume` | def | L2155–L2161 |
| `admin_emergency_stop` | def | L2165–L2200 |
| `admin_vps_reboot` | def | L2204–L2216 |
| `health_last` | def | L2220–L2221 |
| `health_dismiss` | def | L2225–L2228 |
| `api_marks_list` | def | L2232–L2239 |
| `api_marks_toggle` | def | L2243–L2261 |
| `api_recent` | def | L2265–L2337 |
| `api_accounts_at_hand` | def | L2341–L2449 |
| `_health_loop` | def | L2452–L2462 |
| `_release_account` | def | L2465–L2486 |
| `_run_lock_janitor` | def | L2489–L2537 |
| `_janitor_loop` | def | L2540–L2550 |
| `_run_window_watcher` | def | L2559–L2631 |
| `_window_watcher_loop` | def | L2634–L2643 |
| `_release_watchdog_tick` | def | L2646–L2745 |
| `_release_watchdog_loop` | def | L2748–L2756 |
| `_jwt_keepalive_loop` | def | L2759–L2787 |
| `_wake_jwt_keeper` | def | L2794–L2805 |
| `_account_refresh_loop` | def | L2808–L2826 |
| `_bot_token` | def | L2832–L2841 |
| `_notify_robert` | def | L2844–L2859 |
| `_startup_telegram_notify` | def | L2862–L2886 |
| `_lifespan` | def | L2890–L2901 |
| `LockRequest` | class | L2907–L2909 |
| `lock_account` | def | L2913–L2952 |
| `PublishRequest` | class | L2955–L2957 |
| `publish_accounts` | def | L2961–L2990 |
| `hide_all_accounts` | def | L2994–L3009 |
| `pool_accounts` | def | L3013–L3031 |
| `api_pool_split` | def | L3035–L3049 |
| `api_pool_publish` | def | L3053–L3087 |
| `unlock_account` | def | L3091–L3109 |
| `_sse_generator` | def | L3112–L3138 |
| `events` | def | L3142–L3152 |
| `account_cards_pipe` | def | L3156–L3182 |
| `account_notes_summary` | def | L3186–L3211 |
| `_record_account_touch` | def | L3214–L3247 |
| `account_find_id` | def | L3251–L3257 |
| `account_details` | def | L3261–L3652 |
| `NoteCreate` | class | L3655–L3656 |
| `create_note` | def | L3660–L3689 |
| `CurpUpdate` | class | L3692–L3693 |
| `update_curp` | def | L3697–L3708 |
| `get_clabes` | def | L3718–L3727 |
| `refresh_clabes` | def | L3731–L3741 |
| `_persist_withdrawal` | def | L3750–L3796 |
| `withdraw` | def | L3800–L3852 |
| `withdraw_status` | def | L3856–L3919 |
| `delete_note` | def | L3923–L3935 |
| `CombosRequest` | class | L3938–L3939 |
| `accounts_combos` | def | L3943–L3956 |
| `accounts_pass_map` | def | L3960–L3965 |
| `list_all_cards` | def | L3969–L4045 |
| `activity_feed` | def | L4049–L4146 |
| `list_deposits` | def | L4150–L4179 |
| `deposits_stats` | def | L4183–L4208 |
| `_persist_auto_mission` | def | L4216–L4246 |
| `admin_maintenance_state` | def | L4250–L4253 |
| `MaintenanceToggleRequest` | class | L4256–L4257 |
| `admin_maintenance_toggle` | def | L4261–L4282 |
| `auto_deposit_create` | def | L4286–L4322 |
| `auto_deposit_cancel` | def | L4326–L4352 |
| `operator_my_accounts` | def | L4356–L4446 |
| `operator_release_account` | def | L4450–L4467 |
| `operator_withdraw` | def | L4471–L4529 |
| `operator_auto_withdraw` | def | L4533–L4569 |
| `auto_deposit_confirm` | def | L4573–L4592 |
| `operator_missions` | def | L4596–L4614 |
| `operator_recent_ticker` | def | L4618–L4743 |
| `auto_deposit_status` | def | L4747–L4758 |
| `register_operator_strike` | def | L4761–L4794 |
| `bot_start_info` | def | L4798–L4834 |
| `bot_operator_info` | def | L4838–L4877 |
| `bot_help_info` | def | L4881–L4895 |
| `bot_pause_mission` | def | L4899–L4928 |
| `bot_resume_mission` | def | L4932–L4950 |
| `bot_cancel_mission` | def | L4955–L4990 |
| `bot_bet_create` | def | L4994–L5163 |
| `filter_and_sanitize_check_combos` | def | L5166–L5251 |
| `BotCheckRequest` | class | L5254–L5258 |
| `bot_check` | def | L5261–L5342 |
...
| `run_auto_mission` | def | L918–L1789 |
