...
| `_broadcast` | def | L249–L267 |
| `_dequeue_blocking` | def | L270–L275 |
| `_no_cache_static_assets` | def | L283–L295 |
| `favicon` | def | L303–L304 |
| `login_page` | def | L308–L311 |
| `index` | def | L315–L328 |
| `auth_login` | def | L337–L362 |
| `auth_set_password` | def | L366–L390 |
| `auth_logout` | def | L394–L398 |
| `auth_me` | def | L402–L407 |
| `health` | def | L413–L419 |
| `_build_search_clause` | def | L422–L466 |
| `list_accounts` | def | L470–L559 |
| `list_users` | def | L565–L573 |
| `list_assignments` | def | L577–L598 |
| `AssignRequest` | class | L601–L603 |
| `assign_accounts` | def | L607–L626 |
| `unassign_accounts` | def | L630–L641 |
| `stats` | def | L645–L652 |
| `_wsai_status` | def | L667–L692 |
| `_maybe_alert_broadcast` | def | L699–L716 |
| `_check_one_proxy` | def | L719–L745 |
| `_proxy_health` | def | L748–L797 |
| `_capmonster_balance` | def | L800–L820 |
| `_operator_color` | def | L825–L826 |
| `_resolve_who` | def | L829–L842 |
| `_event_visible_to` | def | L845–L866 |
| `superadmin_kpis` | def | L870–L1113 |
| `RefreshRequest` | class | L1118–L1119 |
| `accounts_refresh` | def | L1123–L1142 |
| `get_logs` | def | L1148–L1173 |
| `_run_health_checks` | def | L1181–L1217 |
| `health_full` | def | L1221–L1222 |
| `_require_sa` | def | L1230–L1232 |
| `admin_diag` | def | L1236–L1267 |
| `admin_ping` | def | L1271–L1292 |
| `admin_refresh_proxy` | def | L1296–L1303 |
| `admin_services_restart` | def | L1307–L1321 |
| `admin_export_logs` | def | L1325–L1337 |
| `admin_pause_state` | def | L1345–L1347 |
| `admin_pause` | def | L1351–L1363 |
| `admin_resume` | def | L1367–L1373 |
| `admin_emergency_stop` | def | L1377–L1412 |
| `admin_vps_reboot` | def | L1416–L1428 |
