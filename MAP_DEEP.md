...
| `list_accounts` | def | L424–L513 |
| `list_users` | def | L519–L527 |
| `list_assignments` | def | L531–L552 |
| `AssignRequest` | class | L555–L557 |
| `assign_accounts` | def | L561–L580 |
| `unassign_accounts` | def | L584–L595 |
| `stats` | def | L599–L606 |
| `_wsai_status` | def | L621–L646 |
| `_maybe_alert_broadcast` | def | L653–L670 |
| `_check_one_proxy` | def | L673–L699 |
| `_proxy_health` | def | L702–L751 |
| `_capmonster_balance` | def | L754–L774 |
| `_operator_color` | def | L779–L780 |
| `_resolve_who` | def | L783–L791 |
| `superadmin_kpis` | def | L795–L1038 |
| `RefreshRequest` | class | L1043–L1044 |
| `accounts_refresh` | def | L1048–L1067 |
| `get_logs` | def | L1073–L1098 |
| `_run_health_checks` | def | L1106–L1142 |
| `health_full` | def | L1146–L1147 |
| `_require_sa` | def | L1155–L1157 |
| `admin_diag` | def | L1161–L1192 |
| `admin_ping` | def | L1196–L1217 |
| `admin_refresh_proxy` | def | L1221–L1228 |
| `admin_services_restart` | def | L1232–L1246 |
| `admin_export_logs` | def | L1250–L1262 |
| `admin_pause_state` | def | L1270–L1272 |
| `admin_pause` | def | L1276–L1288 |
| `admin_resume` | def | L1292–L1298 |
| `admin_emergency_stop` | def | L1302–L1337 |
| `admin_vps_reboot` | def | L1341–L1353 |
| `health_last` | def | L1357–L1358 |
| `health_dismiss` | def | L1362–L1365 |
| `_health_loop` | def | L1368–L1378 |
| `_release_account` | def | L1381–L1401 |
| `_run_lock_janitor` | def | L1404–L1452 |
| `_janitor_loop` | def | L1455–L1465 |
| `_run_window_watcher` | def | L1474–L1546 |
| `_window_watcher_loop` | def | L1549–L1558 |
| `_release_watchdog_tick` | def | L1561–L1660 |
| `_release_watchdog_loop` | def | L1663–L1671 |
| `_start_bg_tasks` | def | L1675–L1679 |
| `LockRequest` | class | L1682–L1684 |
| `lock_account` | def | L1688–L1727 |
| `PublishRequest` | class | L1730–L1732 |
| `publish_accounts` | def | L1736–L1759 |
| `hide_all_accounts` | def | L1763–L1775 |
| `pool_accounts` | def | L1779–L1797 |
| `unlock_account` | def | L1801–L1819 |
| `_sse_generator` | def | L1822–L1849 |
| `events` | def | L1853–L1858 |
| `account_cards_pipe` | def | L1862–L1888 |
| `account_notes_summary` | def | L1892–L1917 |
| `account_details` | def | L1921–L2132 |
| `NoteCreate` | class | L2135–L2136 |
| `create_note` | def | L2140–L2169 |
| `CurpUpdate` | class | L2172–L2173 |
| `update_curp` | def | L2177–L2188 |
| `delete_note` | def | L2192–L2204 |
| `CombosRequest` | class | L2207–L2208 |
| `accounts_combos` | def | L2212–L2225 |
| `accounts_pass_map` | def | L2229–L2234 |
| `list_all_cards` | def | L2238–L2313 |
| `activity_feed` | def | L2317–L2434 |
| `list_deposits` | def | L2438–L2467 |
| `deposits_stats` | def | L2471–L2496 |
...
| `bin_stats_overview` | def | L260–L305 |
| `_auto_lock_for_deposit` | def | L308–L359 |
| `_window_status` | def | L362–L404 |
| `_check_caps` | def | L407–L420 |
| `_load_deps` | def | L423–L434 |
| `_parse_pipe` | def | L437–L458 |
| `_check_card_velocity` | def | L478–L525 |
| `_record_attempt` | def | L528–L638 |
| `_safe_phase` | def | L648–L655 |
| `_build_admin_proxy_url` | def | L658–L662 |
| `_refresh_account_after_deposit` | def | L665–L712 |
| `_should_relogin_after_401` | def | L715–L719 |
| `_acquire_session_and_begin` | def | L722–L970 |
| `_run_deposit_with_phases` | def | L973–L1287 |
| `deposit_execute_stream` | def | L1291–L1499 |
| `cap_status` | def | L1503–L1515 |
| `_mm_is_real_decline` | def | L1552–L1558 |
| `_mm_session_get` | def | L1600–L1604 |
| `_mm_session_update` | def | L1607–L1616 |
| `multi_stream` | def | L1620–L2077 |
| `multi_cancel` | def | L2081–L2086 |
| `scheduled_create` | def | L2099–L2447 |
| `scheduled_list` | def | L2451–L2473 |
| `scheduled_cancel` | def | L2477–L2485 |
