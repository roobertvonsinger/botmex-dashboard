...
| `get_logs_telegram` | def | L1939–L1985 |
| `_run_health_checks` | def | L1993–L2029 |
| `health_full` | def | L2033–L2034 |
| `_require_sa` | def | L2042–L2044 |
| `admin_diag` | def | L2048–L2079 |
| `admin_ping` | def | L2083–L2104 |
| `admin_refresh_proxy` | def | L2108–L2115 |
| `admin_services_restart` | def | L2119–L2140 |
| `admin_export_logs` | def | L2144–L2160 |
| `admin_pause_state` | def | L2168–L2170 |
| `admin_pause` | def | L2174–L2186 |
| `admin_resume` | def | L2190–L2196 |
| `admin_emergency_stop` | def | L2200–L2235 |
| `admin_vps_reboot` | def | L2239–L2251 |
| `health_last` | def | L2255–L2256 |
| `health_dismiss` | def | L2260–L2263 |
| `api_marks_list` | def | L2267–L2274 |
| `api_marks_toggle` | def | L2278–L2296 |
| `api_recent` | def | L2300–L2372 |
| `api_accounts_at_hand` | def | L2376–L2484 |
| `_health_loop` | def | L2487–L2497 |
| `_release_account` | def | L2500–L2521 |
| `_run_lock_janitor` | def | L2524–L2572 |
| `_janitor_loop` | def | L2575–L2585 |
| `_run_window_watcher` | def | L2594–L2666 |
| `_window_watcher_loop` | def | L2669–L2678 |
| `_release_watchdog_tick` | def | L2681–L2780 |
| `_release_watchdog_loop` | def | L2783–L2791 |
| `_jwt_keepalive_loop` | def | L2794–L2822 |
| `_wake_jwt_keeper` | def | L2829–L2840 |
| `_account_refresh_loop` | def | L2843–L2861 |
| `_bot_token` | def | L2867–L2876 |
| `_notify_robert` | def | L2879–L2894 |
| `_startup_telegram_notify` | def | L2897–L2921 |
| `_lifespan` | def | L2925–L2936 |
| `LockRequest` | class | L2942–L2944 |
| `lock_account` | def | L2948–L2987 |
| `PublishRequest` | class | L2990–L2992 |
| `publish_accounts` | def | L2996–L3025 |
| `hide_all_accounts` | def | L3029–L3044 |
| `pool_accounts` | def | L3048–L3066 |
| `api_pool_split` | def | L3070–L3084 |
| `api_pool_publish` | def | L3088–L3122 |
| `unlock_account` | def | L3126–L3144 |
| `_sse_generator` | def | L3147–L3176 |
| `events` | def | L3180–L3190 |
| `account_cards_pipe` | def | L3194–L3220 |
| `account_notes_summary` | def | L3224–L3249 |
| `_record_account_touch` | def | L3252–L3285 |
| `account_find_id` | def | L3289–L3295 |
| `account_details` | def | L3299–L3690 |
| `NoteCreate` | class | L3693–L3694 |
| `create_note` | def | L3698–L3727 |
| `CurpUpdate` | class | L3730–L3731 |
| `update_curp` | def | L3735–L3746 |
| `get_clabes` | def | L3756–L3765 |
| `refresh_clabes` | def | L3769–L3779 |
| `_persist_withdrawal` | def | L3788–L3834 |
| `withdraw` | def | L3838–L3890 |
| `withdraw_status` | def | L3894–L3957 |
| `delete_note` | def | L3961–L3973 |
| `CombosRequest` | class | L3976–L3977 |
| `accounts_combos` | def | L3981–L3994 |
| `accounts_pass_map` | def | L3998–L4003 |
| `list_all_cards` | def | L4007–L4083 |
| `activity_feed` | def | L4087–L4184 |
| `list_deposits` | def | L4188–L4217 |
| `deposits_stats` | def | L4221–L4246 |
| `_persist_auto_mission` | def | L4254–L4284 |
| `admin_maintenance_state` | def | L4288–L4291 |
| `MaintenanceToggleRequest` | class | L4294–L4295 |
| `admin_maintenance_toggle` | def | L4299–L4320 |
| `auto_deposit_create` | def | L4324–L4360 |
| `auto_deposit_cancel` | def | L4364–L4390 |
| `emergency_stop_all_deposits` | def | L4394–L4425 |
| `operator_my_accounts` | def | L4429–L4519 |
| `operator_release_account` | def | L4523–L4540 |
| `operator_withdraw` | def | L4544–L4602 |
| `operator_auto_withdraw` | def | L4606–L4642 |
| `auto_deposit_confirm` | def | L4646–L4665 |
| `operator_missions` | def | L4669–L4687 |
| `operator_recent_ticker` | def | L4691–L4816 |
| `auto_deposit_status` | def | L4820–L4831 |
| `register_operator_strike` | def | L4834–L4867 |
| `bot_start_info` | def | L4871–L4907 |
| `bot_operator_info` | def | L4911–L4950 |
| `bot_help_info` | def | L4954–L4968 |
| `bot_pause_mission` | def | L4972–L5001 |
| `bot_resume_mission` | def | L5005–L5023 |
| `bot_cancel_mission` | def | L5028–L5063 |
| `bot_bet_create` | def | L5067–L5236 |
| `filter_and_sanitize_check_combos` | def | L5239–L5324 |
| `BotCheckRequest` | class | L5327–L5331 |
| `bot_check` | def | L5334–L5415 |
