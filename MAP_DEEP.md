...
|---------|------|--------|
| `db` | def | L148–L194 |
| `_db_write_with_retry` | def | L197–L229 |
| `_migrate` | def | L232–L438 |
| `_backfill_grades_v10_m7` | def | L441–L512 |
| `_resolve_operator` | def | L518–L542 |
| `_is_sa` | def | L545–L547 |
| `_visible_emails` | def | L550–L572 |
| `_broadcast` | def | L579–L597 |
| `_dequeue_blocking` | def | L600–L605 |
| `_is_maintenance_active` | def | L614–L617 |
| `_maintenance_gate_middleware` | def | L620–L648 |
| `_no_cache_static_assets` | def | L652–L664 |
| `favicon` | def | L679–L680 |
| `maintenance_page` | def | L684–L685 |
| `login_page` | def | L689–L693 |
| `_asset_mtimes` | def | L710–L717 |
| `_frontend_version` | def | L720–L724 |
| `_own_portal_path` | def | L727–L728 |
| `user_portal_page` | def | L732–L748 |
| `portal_page` | def | L752–L759 |
| `dashboard_page` | def | L763–L793 |
| `index` | def | L797–L806 |
| `api_version` | def | L810–L820 |
| `auth_login` | def | L829–L860 |
| `auth_set_password` | def | L864–L888 |
| `auth_logout` | def | L892–L896 |
| `auth_me` | def | L900–L905 |
| `health` | def | L911–L917 |
| `_build_search_clause` | def | L920–L964 |
| `list_accounts` | def | L968–L1090 |
| `list_users` | def | L1096–L1104 |
| `list_assignments` | def | L1108–L1129 |
| `AssignRequest` | class | L1132–L1134 |
| `assign_accounts` | def | L1138–L1157 |
| `unassign_accounts` | def | L1161–L1172 |
| `stats` | def | L1176–L1183 |
| `_wsai_status` | def | L1198–L1223 |
| `_maybe_alert_broadcast` | def | L1230–L1247 |
| `_check_one_proxy` | def | L1250–L1276 |
| `_proxy_health` | def | L1279–L1328 |
| `_capmonster_balance` | def | L1331–L1351 |
| `_operator_color` | def | L1356–L1371 |
| `_resolve_who` | def | L1374–L1387 |
| `_event_visible_to` | def | L1390–L1416 |
| `superadmin_kpis` | def | L1420–L1663 |
| `RefreshRequest` | class | L1668–L1669 |
| `accounts_refresh` | def | L1673–L1692 |
| `_tail_log_file` | def | L1712–L1740 |
| `get_logs` | def | L1744–L1754 |
| `get_logs_telegram` | def | L1764–L1779 |
| `_run_health_checks` | def | L1787–L1823 |
| `health_full` | def | L1827–L1828 |
| `_require_sa` | def | L1836–L1838 |
| `admin_diag` | def | L1842–L1873 |
| `admin_ping` | def | L1877–L1898 |
| `admin_refresh_proxy` | def | L1902–L1909 |
| `admin_services_restart` | def | L1913–L1934 |
| `admin_export_logs` | def | L1938–L1954 |
| `admin_pause_state` | def | L1962–L1964 |
| `admin_pause` | def | L1968–L1980 |
| `admin_resume` | def | L1984–L1990 |
| `admin_emergency_stop` | def | L1994–L2029 |
| `admin_vps_reboot` | def | L2033–L2045 |
| `health_last` | def | L2049–L2050 |
| `health_dismiss` | def | L2054–L2057 |
| `api_marks_list` | def | L2061–L2068 |
| `api_marks_toggle` | def | L2072–L2090 |
| `api_recent` | def | L2094–L2166 |
| `api_accounts_at_hand` | def | L2170–L2278 |
| `_health_loop` | def | L2281–L2291 |
| `_release_account` | def | L2294–L2315 |
| `_run_lock_janitor` | def | L2318–L2366 |
| `_janitor_loop` | def | L2369–L2379 |
| `_run_window_watcher` | def | L2388–L2460 |
| `_window_watcher_loop` | def | L2463–L2472 |
| `_release_watchdog_tick` | def | L2475–L2574 |
| `_release_watchdog_loop` | def | L2577–L2585 |
| `_jwt_keepalive_loop` | def | L2588–L2605 |
| `_account_refresh_loop` | def | L2608–L2626 |
| `_bot_token` | def | L2632–L2641 |
| `_notify_robert` | def | L2644–L2659 |
| `_startup_telegram_notify` | def | L2662–L2686 |
| `_start_bg_tasks` | def | L2690–L2697 |
| `LockRequest` | class | L2700–L2702 |
| `lock_account` | def | L2706–L2745 |
| `PublishRequest` | class | L2748–L2750 |
| `publish_accounts` | def | L2754–L2783 |
| `hide_all_accounts` | def | L2787–L2802 |
| `pool_accounts` | def | L2806–L2824 |
| `api_pool_split` | def | L2828–L2842 |
| `api_pool_publish` | def | L2846–L2880 |
| `unlock_account` | def | L2884–L2902 |
| `_sse_generator` | def | L2905–L2931 |
| `events` | def | L2935–L2945 |
| `account_cards_pipe` | def | L2949–L2975 |
| `account_notes_summary` | def | L2979–L3004 |
| `_record_account_touch` | def | L3007–L3040 |
| `account_find_id` | def | L3044–L3050 |
| `account_details` | def | L3054–L3434 |
| `NoteCreate` | class | L3437–L3438 |
| `create_note` | def | L3442–L3471 |
| `CurpUpdate` | class | L3474–L3475 |
| `update_curp` | def | L3479–L3490 |
| `get_clabes` | def | L3500–L3509 |
| `refresh_clabes` | def | L3513–L3523 |
| `_persist_withdrawal` | def | L3532–L3578 |
| `withdraw` | def | L3582–L3627 |
| `withdraw_status` | def | L3631–L3788 |
| `delete_note` | def | L3792–L3804 |
| `CombosRequest` | class | L3807–L3808 |
| `accounts_combos` | def | L3812–L3825 |
| `accounts_pass_map` | def | L3829–L3834 |
| `list_all_cards` | def | L3838–L3913 |
| `activity_feed` | def | L3917–L4014 |
| `list_deposits` | def | L4018–L4047 |
| `deposits_stats` | def | L4051–L4076 |
| `_persist_auto_mission` | def | L4084–L4114 |
| `admin_maintenance_state` | def | L4118–L4121 |
| `MaintenanceToggleRequest` | class | L4124–L4125 |
| `admin_maintenance_toggle` | def | L4129–L4150 |
| `auto_deposit_create` | def | L4154–L4190 |
| `auto_deposit_cancel` | def | L4194–L4220 |
| `operator_my_accounts` | def | L4224–L4257 |
| `operator_release_account` | def | L4261–L4278 |
| `operator_withdraw` | def | L4282–L4333 |
| `operator_missions` | def | L4337–L4355 |
| `auto_deposit_status` | def | L4359–L4370 |
| `register_operator_strike` | def | L4373–L4406 |
| `bot_start_info` | def | L4410–L4446 |
| `bot_operator_info` | def | L4450–L4489 |
| `bot_help_info` | def | L4493–L4507 |
| `bot_pause_mission` | def | L4511–L4540 |
| `bot_resume_mission` | def | L4544–L4562 |
| `bot_cancel_mission` | def | L4567–L4602 |
| `bot_bet_create` | def | L4606–L4775 |
| `filter_and_sanitize_check_combos` | def | L4778–L4863 |
| `BotCheckRequest` | class | L4866–L4870 |
| `bot_check` | def | L4873–L4954 |
