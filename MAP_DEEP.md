...
| `account_details` | def | L2815–L3155 |
| `NoteCreate` | class | L3158–L3159 |
| `create_note` | def | L3163–L3192 |
| `CurpUpdate` | class | L3195–L3196 |
| `update_curp` | def | L3200–L3211 |
| `get_clabes` | def | L3221–L3230 |
| `refresh_clabes` | def | L3234–L3244 |
| `_persist_withdrawal` | def | L3253–L3299 |
| `withdraw` | def | L3303–L3348 |
| `withdraw_status` | def | L3352–L3509 |
| `delete_note` | def | L3513–L3525 |
| `CombosRequest` | class | L3528–L3529 |
| `accounts_combos` | def | L3533–L3546 |
| `accounts_pass_map` | def | L3550–L3555 |
| `list_all_cards` | def | L3559–L3634 |
| `activity_feed` | def | L3638–L3735 |
| `list_deposits` | def | L3739–L3768 |
| `deposits_stats` | def | L3772–L3797 |
| `_persist_auto_mission` | def | L3805–L3835 |
| `auto_deposit_create` | def | L3839–L3875 |
| `auto_deposit_cancel` | def | L3879–L3905 |
| `auto_deposit_status` | def | L3909–L3920 |
