...
| `user_portal_page` | def | L733–L749 |
| `portal_page` | def | L753–L760 |
| `dashboard_page` | def | L764–L794 |
| `index` | def | L798–L807 |
| `api_version` | def | L811–L821 |
| `auth_login` | def | L830–L861 |
| `auth_set_password` | def | L865–L889 |
| `auth_logout` | def | L893–L897 |
| `auth_me` | def | L901–L906 |
| `health` | def | L912–L918 |
| `_build_search_clause` | def | L921–L965 |
| `list_accounts` | def | L969–L1091 |
| `list_users` | def | L1097–L1105 |
| `list_assignments` | def | L1109–L1130 |
| `AssignRequest` | class | L1133–L1135 |
| `assign_accounts` | def | L1139–L1158 |
| `unassign_accounts` | def | L1162–L1173 |
| `stats` | def | L1177–L1184 |
| `_wsai_status` | def | L1199–L1224 |
| `_maybe_alert_broadcast` | def | L1231–L1248 |
| `_check_one_proxy` | def | L1251–L1277 |
| `_proxy_health` | def | L1280–L1329 |
| `_capmonster_balance` | def | L1332–L1352 |
| `_operator_color` | def | L1357–L1372 |
| `_resolve_who` | def | L1375–L1388 |
| `_event_visible_to` | def | L1391–L1417 |
| `superadmin_kpis` | def | L1421–L1664 |
| `RefreshRequest` | class | L1669–L1670 |
| `accounts_refresh` | def | L1674–L1693 |
| `_tail_log_file` | def | L1713–L1741 |
| `get_logs` | def | L1745–L1755 |
| `get_logs_telegram` | def | L1765–L1780 |
| `_run_health_checks` | def | L1788–L1824 |
| `health_full` | def | L1828–L1829 |
| `_require_sa` | def | L1837–L1839 |
| `admin_diag` | def | L1843–L1874 |
| `admin_ping` | def | L1878–L1899 |
| `admin_refresh_proxy` | def | L1903–L1910 |
| `admin_services_restart` | def | L1914–L1935 |
| `admin_export_logs` | def | L1939–L1955 |
| `admin_pause_state` | def | L1963–L1965 |
| `admin_pause` | def | L1969–L1981 |
| `admin_resume` | def | L1985–L1991 |
| `admin_emergency_stop` | def | L1995–L2030 |
| `admin_vps_reboot` | def | L2034–L2046 |
| `health_last` | def | L2050–L2051 |
| `health_dismiss` | def | L2055–L2058 |
| `api_marks_list` | def | L2062–L2069 |
| `api_marks_toggle` | def | L2073–L2091 |
| `api_recent` | def | L2095–L2167 |
| `api_accounts_at_hand` | def | L2171–L2279 |
| `_health_loop` | def | L2282–L2292 |
| `_release_account` | def | L2295–L2316 |
| `_run_lock_janitor` | def | L2319–L2367 |
| `_janitor_loop` | def | L2370–L2380 |
| `_run_window_watcher` | def | L2389–L2461 |
| `_window_watcher_loop` | def | L2464–L2473 |
| `_release_watchdog_tick` | def | L2476–L2575 |
| `_release_watchdog_loop` | def | L2578–L2586 |
| `_jwt_keepalive_loop` | def | L2589–L2606 |
| `_account_refresh_loop` | def | L2609–L2627 |
| `_bot_token` | def | L2633–L2642 |
| `_notify_robert` | def | L2645–L2660 |
| `_startup_telegram_notify` | def | L2663–L2687 |
| `_start_bg_tasks` | def | L2691–L2698 |
| `LockRequest` | class | L2701–L2703 |
| `lock_account` | def | L2707–L2746 |
| `PublishRequest` | class | L2749–L2751 |
| `publish_accounts` | def | L2755–L2784 |
| `hide_all_accounts` | def | L2788–L2803 |
| `pool_accounts` | def | L2807–L2825 |
| `api_pool_split` | def | L2829–L2843 |
| `api_pool_publish` | def | L2847–L2881 |
| `unlock_account` | def | L2885–L2903 |
| `_sse_generator` | def | L2906–L2932 |
| `events` | def | L2936–L2946 |
| `account_cards_pipe` | def | L2950–L2976 |
| `account_notes_summary` | def | L2980–L3005 |
| `_record_account_touch` | def | L3008–L3041 |
| `account_find_id` | def | L3045–L3051 |
| `account_details` | def | L3055–L3435 |
| `NoteCreate` | class | L3438–L3439 |
| `create_note` | def | L3443–L3472 |
| `CurpUpdate` | class | L3475–L3476 |
| `update_curp` | def | L3480–L3491 |
| `get_clabes` | def | L3501–L3510 |
| `refresh_clabes` | def | L3514–L3524 |
| `_persist_withdrawal` | def | L3533–L3579 |
| `withdraw` | def | L3583–L3628 |
| `withdraw_status` | def | L3632–L3789 |
| `delete_note` | def | L3793–L3805 |
