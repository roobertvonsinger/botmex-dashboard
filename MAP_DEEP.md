...
| `index` | def | L354–L374 |
| `api_version` | def | L378–L390 |
| `auth_login` | def | L399–L430 |
| `auth_set_password` | def | L434–L458 |
| `auth_logout` | def | L462–L466 |
| `auth_me` | def | L470–L475 |
| `health` | def | L481–L487 |
| `_build_search_clause` | def | L490–L534 |
| `list_accounts` | def | L538–L627 |
| `list_users` | def | L633–L641 |
| `list_assignments` | def | L645–L666 |
| `AssignRequest` | class | L669–L671 |
| `assign_accounts` | def | L675–L694 |
| `unassign_accounts` | def | L698–L709 |
| `stats` | def | L713–L720 |
| `_wsai_status` | def | L735–L760 |
| `_maybe_alert_broadcast` | def | L767–L784 |
| `_check_one_proxy` | def | L787–L813 |
| `_proxy_health` | def | L816–L865 |
| `_capmonster_balance` | def | L868–L888 |
| `_operator_color` | def | L893–L894 |
| `_resolve_who` | def | L897–L910 |
| `_event_visible_to` | def | L913–L939 |
| `superadmin_kpis` | def | L943–L1186 |
| `RefreshRequest` | class | L1191–L1192 |
| `accounts_refresh` | def | L1196–L1215 |
| `get_logs` | def | L1221–L1246 |
| `_run_health_checks` | def | L1254–L1290 |
| `health_full` | def | L1294–L1295 |
| `_require_sa` | def | L1303–L1305 |
| `admin_diag` | def | L1309–L1340 |
| `admin_ping` | def | L1344–L1365 |
| `admin_refresh_proxy` | def | L1369–L1376 |
| `admin_services_restart` | def | L1380–L1394 |
| `admin_export_logs` | def | L1398–L1410 |
| `admin_pause_state` | def | L1418–L1420 |
| `admin_pause` | def | L1424–L1436 |
| `admin_resume` | def | L1440–L1446 |
| `admin_emergency_stop` | def | L1450–L1485 |
| `admin_vps_reboot` | def | L1489–L1501 |
| `health_last` | def | L1505–L1506 |
| `health_dismiss` | def | L1510–L1513 |
| `api_marks_list` | def | L1517–L1524 |
| `api_marks_toggle` | def | L1528–L1546 |
| `api_recent` | def | L1550–L1622 |
| `api_accounts_at_hand` | def | L1626–L1734 |
| `_health_loop` | def | L1737–L1747 |
| `_release_account` | def | L1750–L1771 |
| `_run_lock_janitor` | def | L1774–L1822 |
| `_janitor_loop` | def | L1825–L1835 |
| `_run_window_watcher` | def | L1844–L1916 |
| `_window_watcher_loop` | def | L1919–L1928 |
| `_release_watchdog_tick` | def | L1931–L2030 |
| `_release_watchdog_loop` | def | L2033–L2041 |
| `_start_bg_tasks` | def | L2045–L2049 |
| `LockRequest` | class | L2052–L2054 |
| `lock_account` | def | L2058–L2097 |
| `PublishRequest` | class | L2100–L2102 |
| `publish_accounts` | def | L2106–L2129 |
| `hide_all_accounts` | def | L2133–L2145 |
| `pool_accounts` | def | L2149–L2167 |
| `api_pool_split` | def | L2171–L2185 |
| `api_pool_publish` | def | L2189–L2221 |
| `unlock_account` | def | L2225–L2243 |
| `_sse_generator` | def | L2246–L2272 |
| `events` | def | L2276–L2286 |
| `account_cards_pipe` | def | L2290–L2316 |
| `account_notes_summary` | def | L2320–L2345 |
| `account_details` | def | L2349–L2643 |
| `NoteCreate` | class | L2646–L2647 |
| `create_note` | def | L2651–L2680 |
| `CurpUpdate` | class | L2683–L2684 |
| `update_curp` | def | L2688–L2699 |
| `delete_note` | def | L2703–L2715 |
| `CombosRequest` | class | L2718–L2719 |
| `accounts_combos` | def | L2723–L2736 |
| `accounts_pass_map` | def | L2740–L2745 |
| `list_all_cards` | def | L2749–L2824 |
| `activity_feed` | def | L2828–L2949 |
| `list_deposits` | def | L2953–L2982 |
| `deposits_stats` | def | L2986–L3011 |
