...
| `list_accounts` | def | L1096–L1226 |
| `list_users` | def | L1232–L1240 |
| `list_assignments` | def | L1244–L1265 |
| `AssignRequest` | class | L1268–L1270 |
| `assign_accounts` | def | L1274–L1293 |
| `unassign_accounts` | def | L1297–L1308 |
| `stats` | def | L1312–L1319 |
| `_wsai_status` | def | L1334–L1359 |
| `_maybe_alert_broadcast` | def | L1366–L1383 |
| `_check_one_proxy` | def | L1386–L1412 |
| `_proxy_health` | def | L1415–L1464 |
| `_capmonster_balance` | def | L1467–L1487 |
| `_operator_color` | def | L1492–L1507 |
| `_resolve_who` | def | L1510–L1523 |
| `_event_visible_to` | def | L1526–L1552 |
| `superadmin_kpis` | def | L1556–L1799 |
| `RefreshRequest` | class | L1804–L1805 |
| `accounts_refresh` | def | L1809–L1828 |
| `_tail_log_file` | def | L1855–L1883 |
| `get_logs` | def | L1887–L1909 |
| `get_logs_telegram` | def | L1919–L1934 |
| `_run_health_checks` | def | L1942–L1978 |
| `health_full` | def | L1982–L1983 |
| `_require_sa` | def | L1991–L1993 |
| `admin_diag` | def | L1997–L2028 |
| `admin_ping` | def | L2032–L2053 |
| `admin_refresh_proxy` | def | L2057–L2064 |
| `admin_services_restart` | def | L2068–L2089 |
| `admin_export_logs` | def | L2093–L2109 |
| `admin_pause_state` | def | L2117–L2119 |
| `admin_pause` | def | L2123–L2135 |
| `admin_resume` | def | L2139–L2145 |
| `admin_emergency_stop` | def | L2149–L2184 |
| `admin_vps_reboot` | def | L2188–L2200 |
| `health_last` | def | L2204–L2205 |
| `health_dismiss` | def | L2209–L2212 |
| `api_marks_list` | def | L2216–L2223 |
| `api_marks_toggle` | def | L2227–L2245 |
| `api_recent` | def | L2249–L2321 |
| `api_accounts_at_hand` | def | L2325–L2433 |
| `_health_loop` | def | L2436–L2446 |
| `_release_account` | def | L2449–L2470 |
| `_run_lock_janitor` | def | L2473–L2521 |
| `_janitor_loop` | def | L2524–L2534 |
| `_run_window_watcher` | def | L2543–L2615 |
| `_window_watcher_loop` | def | L2618–L2627 |
| `_release_watchdog_tick` | def | L2630–L2729 |
| `_release_watchdog_loop` | def | L2732–L2740 |
| `_jwt_keepalive_loop` | def | L2743–L2771 |
| `_wake_jwt_keeper` | def | L2778–L2789 |
| `_account_refresh_loop` | def | L2792–L2810 |
| `_bot_token` | def | L2816–L2825 |
| `_notify_robert` | def | L2828–L2843 |
| `_startup_telegram_notify` | def | L2846–L2870 |
| `_lifespan` | def | L2874–L2885 |
| `LockRequest` | class | L2891–L2893 |
| `lock_account` | def | L2897–L2936 |
| `PublishRequest` | class | L2939–L2941 |
| `publish_accounts` | def | L2945–L2974 |
| `hide_all_accounts` | def | L2978–L2993 |
| `pool_accounts` | def | L2997–L3015 |
| `api_pool_split` | def | L3019–L3033 |
| `api_pool_publish` | def | L3037–L3071 |
| `unlock_account` | def | L3075–L3093 |
| `_sse_generator` | def | L3096–L3122 |
| `events` | def | L3126–L3136 |
| `account_cards_pipe` | def | L3140–L3166 |
| `account_notes_summary` | def | L3170–L3195 |
| `_record_account_touch` | def | L3198–L3231 |
| `account_find_id` | def | L3235–L3241 |
| `account_details` | def | L3245–L3636 |
| `NoteCreate` | class | L3639–L3640 |
| `create_note` | def | L3644–L3673 |
| `CurpUpdate` | class | L3676–L3677 |
| `update_curp` | def | L3681–L3692 |
| `get_clabes` | def | L3702–L3711 |
| `refresh_clabes` | def | L3715–L3725 |
| `_persist_withdrawal` | def | L3734–L3780 |
| `withdraw` | def | L3784–L3836 |
| `withdraw_status` | def | L3840–L3903 |
| `delete_note` | def | L3907–L3919 |
| `CombosRequest` | class | L3922–L3923 |
| `accounts_combos` | def | L3927–L3940 |
| `accounts_pass_map` | def | L3944–L3949 |
| `list_all_cards` | def | L3953–L4029 |
| `activity_feed` | def | L4033–L4130 |
| `list_deposits` | def | L4134–L4163 |
| `deposits_stats` | def | L4167–L4192 |
| `_persist_auto_mission` | def | L4200–L4230 |
| `admin_maintenance_state` | def | L4234–L4237 |
| `MaintenanceToggleRequest` | class | L4240–L4241 |
| `admin_maintenance_toggle` | def | L4245–L4266 |
| `auto_deposit_create` | def | L4270–L4306 |
| `auto_deposit_cancel` | def | L4310–L4336 |
| `operator_my_accounts` | def | L4340–L4430 |
| `operator_release_account` | def | L4434–L4451 |
| `operator_withdraw` | def | L4455–L4513 |
| `operator_auto_withdraw` | def | L4517–L4553 |
| `auto_deposit_confirm` | def | L4557–L4576 |
| `operator_missions` | def | L4580–L4598 |
| `operator_recent_ticker` | def | L4602–L4727 |
| `auto_deposit_status` | def | L4731–L4742 |
| `register_operator_strike` | def | L4745–L4778 |
| `bot_start_info` | def | L4782–L4818 |
| `bot_operator_info` | def | L4822–L4861 |
| `bot_help_info` | def | L4865–L4879 |
| `bot_pause_mission` | def | L4883–L4912 |
| `bot_resume_mission` | def | L4916–L4934 |
| `bot_cancel_mission` | def | L4939–L4974 |
| `bot_bet_create` | def | L4978–L5147 |
| `filter_and_sanitize_check_combos` | def | L5150–L5235 |
| `BotCheckRequest` | class | L5238–L5242 |
| `bot_check` | def | L5245–L5326 |
