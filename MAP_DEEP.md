...
|---------|------|--------|
| `db` | def | L169–L221 |
| `_db_write_with_retry` | def | L224–L256 |
| `_migrate` | def | L259–L489 |
| `_backfill_grades_v10_m7` | def | L492–L563 |
| `_resolve_operator` | def | L569–L593 |
| `_is_sa` | def | L596–L598 |
| `_visible_emails` | def | L601–L623 |
| `_broadcast` | def | L630–L648 |
| `_dequeue_blocking` | def | L651–L656 |
| `_is_maintenance_active` | def | L665–L668 |
| `_maintenance_gate_middleware` | def | L671–L699 |
| `_no_cache_static_assets` | def | L703–L715 |
| `favicon` | def | L730–L731 |
| `maintenance_page` | def | L735–L736 |
| `login_page` | def | L740–L744 |
| `_asset_mtimes` | def | L761–L768 |
| `_frontend_version` | def | L771–L775 |
| `_own_portal_path` | def | L778–L779 |
| `_render_frontend_html` | def | L782–L806 |
| `user_portal_page` | def | L810–L825 |
| `portal_page` | def | L829–L836 |
| `dashboard_page` | def | L840–L854 |
| `index` | def | L858–L867 |
| `username_portal_page` | def | L871–L897 |
| `api_version` | def | L901–L911 |
| `auth_login` | def | L920–L951 |
| `auth_set_password` | def | L955–L979 |
| `auth_logout` | def | L983–L987 |
| `auth_me` | def | L991–L1001 |
| `health` | def | L1007–L1013 |
| `_build_search_clause` | def | L1016–L1060 |
| `list_accounts` | def | L1064–L1194 |
| `list_users` | def | L1200–L1208 |
| `list_assignments` | def | L1212–L1233 |
| `AssignRequest` | class | L1236–L1238 |
| `assign_accounts` | def | L1242–L1261 |
| `unassign_accounts` | def | L1265–L1276 |
| `stats` | def | L1280–L1287 |
| `_wsai_status` | def | L1302–L1327 |
| `_maybe_alert_broadcast` | def | L1334–L1351 |
| `_check_one_proxy` | def | L1354–L1380 |
| `_proxy_health` | def | L1383–L1432 |
| `_capmonster_balance` | def | L1435–L1455 |
| `_operator_color` | def | L1460–L1475 |
| `_resolve_who` | def | L1478–L1491 |
| `_event_visible_to` | def | L1494–L1520 |
| `superadmin_kpis` | def | L1524–L1767 |
| `RefreshRequest` | class | L1772–L1773 |
| `accounts_refresh` | def | L1777–L1796 |
| `_tail_log_file` | def | L1816–L1844 |
| `get_logs` | def | L1848–L1858 |
| `get_logs_telegram` | def | L1868–L1883 |
| `_run_health_checks` | def | L1891–L1927 |
| `health_full` | def | L1931–L1932 |
| `_require_sa` | def | L1940–L1942 |
| `admin_diag` | def | L1946–L1977 |
| `admin_ping` | def | L1981–L2002 |
| `admin_refresh_proxy` | def | L2006–L2013 |
| `admin_services_restart` | def | L2017–L2038 |
| `admin_export_logs` | def | L2042–L2058 |
| `admin_pause_state` | def | L2066–L2068 |
| `admin_pause` | def | L2072–L2084 |
| `admin_resume` | def | L2088–L2094 |
| `admin_emergency_stop` | def | L2098–L2133 |
| `admin_vps_reboot` | def | L2137–L2149 |
| `health_last` | def | L2153–L2154 |
| `health_dismiss` | def | L2158–L2161 |
| `api_marks_list` | def | L2165–L2172 |
| `api_marks_toggle` | def | L2176–L2194 |
| `api_recent` | def | L2198–L2270 |
| `api_accounts_at_hand` | def | L2274–L2382 |
| `_health_loop` | def | L2385–L2395 |
| `_release_account` | def | L2398–L2419 |
| `_run_lock_janitor` | def | L2422–L2470 |
| `_janitor_loop` | def | L2473–L2483 |
| `_run_window_watcher` | def | L2492–L2564 |
| `_window_watcher_loop` | def | L2567–L2576 |
| `_release_watchdog_tick` | def | L2579–L2678 |
| `_release_watchdog_loop` | def | L2681–L2689 |
| `_jwt_keepalive_loop` | def | L2692–L2720 |
| `_wake_jwt_keeper` | def | L2727–L2738 |
| `_account_refresh_loop` | def | L2741–L2759 |
| `_bot_token` | def | L2765–L2774 |
| `_notify_robert` | def | L2777–L2792 |
| `_startup_telegram_notify` | def | L2795–L2819 |
| `_start_bg_tasks` | def | L2823–L2830 |
| `LockRequest` | class | L2833–L2835 |
| `lock_account` | def | L2839–L2878 |
| `PublishRequest` | class | L2881–L2883 |
| `publish_accounts` | def | L2887–L2916 |
| `hide_all_accounts` | def | L2920–L2935 |
| `pool_accounts` | def | L2939–L2957 |
| `api_pool_split` | def | L2961–L2975 |
| `api_pool_publish` | def | L2979–L3013 |
| `unlock_account` | def | L3017–L3035 |
| `_sse_generator` | def | L3038–L3064 |
| `events` | def | L3068–L3078 |
| `account_cards_pipe` | def | L3082–L3108 |
| `account_notes_summary` | def | L3112–L3137 |
| `_record_account_touch` | def | L3140–L3173 |
| `account_find_id` | def | L3177–L3183 |
| `account_details` | def | L3187–L3567 |
| `NoteCreate` | class | L3570–L3571 |
| `create_note` | def | L3575–L3604 |
| `CurpUpdate` | class | L3607–L3608 |
| `update_curp` | def | L3612–L3623 |
| `get_clabes` | def | L3633–L3642 |
| `refresh_clabes` | def | L3646–L3656 |
| `_persist_withdrawal` | def | L3665–L3711 |
| `withdraw` | def | L3715–L3767 |
| `withdraw_status` | def | L3771–L3931 |
| `delete_note` | def | L3935–L3947 |
| `CombosRequest` | class | L3950–L3951 |
| `accounts_combos` | def | L3955–L3968 |
| `accounts_pass_map` | def | L3972–L3977 |
| `list_all_cards` | def | L3981–L4057 |
| `activity_feed` | def | L4061–L4158 |
| `list_deposits` | def | L4162–L4191 |
| `deposits_stats` | def | L4195–L4220 |
| `_persist_auto_mission` | def | L4228–L4258 |
| `admin_maintenance_state` | def | L4262–L4265 |
| `MaintenanceToggleRequest` | class | L4268–L4269 |
| `admin_maintenance_toggle` | def | L4273–L4294 |
| `auto_deposit_create` | def | L4298–L4334 |
| `auto_deposit_cancel` | def | L4338–L4364 |
| `operator_my_accounts` | def | L4368–L4437 |
| `operator_release_account` | def | L4441–L4458 |
| `operator_withdraw` | def | L4462–L4520 |
| `operator_missions` | def | L4524–L4542 |
| `auto_deposit_status` | def | L4546–L4557 |
| `register_operator_strike` | def | L4560–L4593 |
| `bot_start_info` | def | L4597–L4633 |
| `bot_operator_info` | def | L4637–L4676 |
| `bot_help_info` | def | L4680–L4694 |
| `bot_pause_mission` | def | L4698–L4727 |
| `bot_resume_mission` | def | L4731–L4749 |
| `bot_cancel_mission` | def | L4754–L4789 |
| `bot_bet_create` | def | L4793–L4962 |
| `filter_and_sanitize_check_combos` | def | L4965–L5050 |
| `BotCheckRequest` | class | L5053–L5057 |
| `bot_check` | def | L5060–L5141 |
...
| `run_auto_mission` | def | L761–L1347 |
