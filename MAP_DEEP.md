...
| `user_portal_page` | def | L804–L819 |
| `portal_page` | def | L823–L830 |
| `dashboard_page` | def | L834–L848 |
| `index` | def | L852–L861 |
| `username_portal_page` | def | L865–L891 |
| `api_version` | def | L895–L905 |
| `auth_login` | def | L914–L945 |
| `auth_set_password` | def | L949–L973 |
| `auth_logout` | def | L977–L981 |
| `auth_me` | def | L985–L995 |
| `health` | def | L1001–L1007 |
| `_build_search_clause` | def | L1010–L1054 |
| `list_accounts` | def | L1058–L1188 |
| `list_users` | def | L1194–L1202 |
| `list_assignments` | def | L1206–L1227 |
| `AssignRequest` | class | L1230–L1232 |
| `assign_accounts` | def | L1236–L1255 |
| `unassign_accounts` | def | L1259–L1270 |
| `stats` | def | L1274–L1281 |
| `_wsai_status` | def | L1296–L1321 |
| `_maybe_alert_broadcast` | def | L1328–L1345 |
| `_check_one_proxy` | def | L1348–L1374 |
| `_proxy_health` | def | L1377–L1426 |
| `_capmonster_balance` | def | L1429–L1449 |
| `_operator_color` | def | L1454–L1469 |
| `_resolve_who` | def | L1472–L1485 |
| `_event_visible_to` | def | L1488–L1514 |
| `superadmin_kpis` | def | L1518–L1761 |
| `RefreshRequest` | class | L1766–L1767 |
| `accounts_refresh` | def | L1771–L1790 |
| `_tail_log_file` | def | L1810–L1838 |
| `get_logs` | def | L1842–L1852 |
| `get_logs_telegram` | def | L1862–L1877 |
| `_run_health_checks` | def | L1885–L1921 |
| `health_full` | def | L1925–L1926 |
| `_require_sa` | def | L1934–L1936 |
| `admin_diag` | def | L1940–L1971 |
| `admin_ping` | def | L1975–L1996 |
| `admin_refresh_proxy` | def | L2000–L2007 |
| `admin_services_restart` | def | L2011–L2032 |
| `admin_export_logs` | def | L2036–L2052 |
| `admin_pause_state` | def | L2060–L2062 |
| `admin_pause` | def | L2066–L2078 |
| `admin_resume` | def | L2082–L2088 |
| `admin_emergency_stop` | def | L2092–L2127 |
| `admin_vps_reboot` | def | L2131–L2143 |
| `health_last` | def | L2147–L2148 |
| `health_dismiss` | def | L2152–L2155 |
| `api_marks_list` | def | L2159–L2166 |
| `api_marks_toggle` | def | L2170–L2188 |
| `api_recent` | def | L2192–L2264 |
| `api_accounts_at_hand` | def | L2268–L2376 |
| `_health_loop` | def | L2379–L2389 |
| `_release_account` | def | L2392–L2413 |
| `_run_lock_janitor` | def | L2416–L2464 |
| `_janitor_loop` | def | L2467–L2477 |
| `_run_window_watcher` | def | L2486–L2558 |
| `_window_watcher_loop` | def | L2561–L2570 |
| `_release_watchdog_tick` | def | L2573–L2672 |
| `_release_watchdog_loop` | def | L2675–L2683 |
| `_jwt_keepalive_loop` | def | L2686–L2714 |
| `_wake_jwt_keeper` | def | L2721–L2732 |
| `_account_refresh_loop` | def | L2735–L2753 |
| `_bot_token` | def | L2759–L2768 |
| `_notify_robert` | def | L2771–L2786 |
| `_startup_telegram_notify` | def | L2789–L2813 |
| `_start_bg_tasks` | def | L2817–L2824 |
| `LockRequest` | class | L2827–L2829 |
| `lock_account` | def | L2833–L2872 |
| `PublishRequest` | class | L2875–L2877 |
| `publish_accounts` | def | L2881–L2910 |
| `hide_all_accounts` | def | L2914–L2929 |
| `pool_accounts` | def | L2933–L2951 |
| `api_pool_split` | def | L2955–L2969 |
| `api_pool_publish` | def | L2973–L3007 |
| `unlock_account` | def | L3011–L3029 |
| `_sse_generator` | def | L3032–L3058 |
| `events` | def | L3062–L3072 |
| `account_cards_pipe` | def | L3076–L3102 |
| `account_notes_summary` | def | L3106–L3131 |
| `_record_account_touch` | def | L3134–L3167 |
| `account_find_id` | def | L3171–L3177 |
| `account_details` | def | L3181–L3561 |
| `NoteCreate` | class | L3564–L3565 |
| `create_note` | def | L3569–L3598 |
| `CurpUpdate` | class | L3601–L3602 |
| `update_curp` | def | L3606–L3617 |
| `get_clabes` | def | L3627–L3636 |
| `refresh_clabes` | def | L3640–L3650 |
| `_persist_withdrawal` | def | L3659–L3705 |
| `withdraw` | def | L3709–L3761 |
| `withdraw_status` | def | L3765–L3925 |
| `delete_note` | def | L3929–L3941 |
| `CombosRequest` | class | L3944–L3945 |
| `accounts_combos` | def | L3949–L3962 |
| `accounts_pass_map` | def | L3966–L3971 |
| `list_all_cards` | def | L3975–L4051 |
| `activity_feed` | def | L4055–L4152 |
| `list_deposits` | def | L4156–L4185 |
| `deposits_stats` | def | L4189–L4214 |
| `_persist_auto_mission` | def | L4222–L4252 |
| `admin_maintenance_state` | def | L4256–L4259 |
| `MaintenanceToggleRequest` | class | L4262–L4263 |
| `admin_maintenance_toggle` | def | L4267–L4288 |
| `auto_deposit_create` | def | L4292–L4328 |
| `auto_deposit_cancel` | def | L4332–L4358 |
| `operator_my_accounts` | def | L4362–L4431 |
| `operator_release_account` | def | L4435–L4452 |
| `operator_withdraw` | def | L4456–L4514 |
| `operator_missions` | def | L4518–L4536 |
| `auto_deposit_status` | def | L4540–L4551 |
| `register_operator_strike` | def | L4554–L4587 |
| `bot_start_info` | def | L4591–L4627 |
| `bot_operator_info` | def | L4631–L4670 |
| `bot_help_info` | def | L4674–L4688 |
| `bot_pause_mission` | def | L4692–L4721 |
| `bot_resume_mission` | def | L4725–L4743 |
| `bot_cancel_mission` | def | L4748–L4783 |
| `bot_bet_create` | def | L4787–L4956 |
| `filter_and_sanitize_check_combos` | def | L4959–L5044 |
| `BotCheckRequest` | class | L5047–L5051 |
| `bot_check` | def | L5054–L5135 |
...
| `run_auto_mission` | def | L761–L1346 |
