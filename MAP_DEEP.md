...
| `_configure_asyncio_exception_handler` | def | L671–L721 |
| `_is_maintenance_active` | def | L732–L737 |
| `_maintenance_gate_middleware` | def | L740–L768 |
| `_no_cache_static_assets` | def | L772–L784 |
| `favicon` | def | L799–L800 |
| `maintenance_page` | def | L804–L805 |
| `login_page` | def | L809–L813 |
| `_asset_mtimes` | def | L830–L837 |
| `_frontend_version` | def | L840–L844 |
| `_own_portal_path` | def | L847–L848 |
| `_render_frontend_html` | def | L851–L875 |
| `user_portal_page` | def | L879–L894 |
| `portal_page` | def | L898–L905 |
| `dashboard_page` | def | L909–L923 |
| `index` | def | L927–L936 |
| `username_portal_page` | def | L940–L966 |
| `api_version` | def | L970–L980 |
| `auth_login` | def | L989–L1020 |
| `auth_set_password` | def | L1024–L1048 |
| `auth_logout` | def | L1052–L1056 |
| `auth_me` | def | L1060–L1070 |
| `health_ping` | def | L1076–L1083 |
| `health` | def | L1089–L1097 |
| `_build_search_clause` | def | L1100–L1144 |
| `list_accounts` | def | L1148–L1294 |
| `list_users` | def | L1300–L1308 |
| `list_assignments` | def | L1312–L1333 |
| `AssignRequest` | class | L1336–L1338 |
| `assign_accounts` | def | L1342–L1361 |
| `unassign_accounts` | def | L1365–L1376 |
| `stats` | def | L1380–L1387 |
| `_wsai_status` | def | L1402–L1427 |
| `_maybe_alert_broadcast` | def | L1434–L1451 |
| `_check_one_proxy` | def | L1454–L1480 |
| `_proxy_health` | def | L1483–L1532 |
| `_capmonster_balance` | def | L1535–L1555 |
| `_operator_color` | def | L1560–L1575 |
| `_resolve_who` | def | L1578–L1591 |
| `_event_visible_to` | def | L1594–L1620 |
| `superadmin_kpis` | def | L1624–L1867 |
| `RefreshRequest` | class | L1872–L1873 |
| `accounts_refresh` | def | L1877–L1896 |
| `_tail_log_file` | def | L1926–L1964 |
| `_get_cached_logs` | def | L1971–L1983 |
| `get_logs` | def | L1997–L2024 |
| `get_logs_telegram` | def | L2028–L2093 |
| `_run_health_checks` | def | L2101–L2137 |
| `health_full` | def | L2141–L2142 |
| `_require_sa` | def | L2150–L2152 |
| `admin_diag` | def | L2156–L2187 |
| `admin_ping` | def | L2191–L2212 |
| `admin_refresh_proxy` | def | L2216–L2223 |
| `admin_services_restart` | def | L2227–L2248 |
| `admin_export_logs` | def | L2252–L2268 |
| `admin_pause_state` | def | L2276–L2278 |
| `admin_pause` | def | L2282–L2294 |
| `admin_resume` | def | L2298–L2304 |
| `admin_emergency_stop` | def | L2308–L2343 |
| `admin_vps_reboot` | def | L2347–L2359 |
| `health_last` | def | L2363–L2364 |
| `health_dismiss` | def | L2368–L2371 |
| `api_marks_list` | def | L2375–L2382 |
| `api_marks_toggle` | def | L2386–L2404 |
| `api_recent` | def | L2408–L2480 |
| `api_accounts_at_hand` | def | L2484–L2592 |
| `_health_loop` | def | L2595–L2605 |
| `_release_account` | def | L2608–L2629 |
| `_run_lock_janitor` | def | L2632–L2680 |
| `_janitor_loop` | def | L2683–L2693 |
| `_run_window_watcher` | def | L2702–L2774 |
| `_window_watcher_loop` | def | L2777–L2786 |
| `_release_watchdog_tick` | def | L2789–L2888 |
| `_release_watchdog_loop` | def | L2891–L2899 |
| `_jwt_keepalive_loop` | def | L2902–L2930 |
| `_wake_jwt_keeper` | def | L2937–L2948 |
| `_account_refresh_loop` | def | L2951–L2969 |
| `_bot_token` | def | L2975–L2984 |
| `_notify_robert` | def | L2987–L3002 |
| `_startup_telegram_notify` | def | L3005–L3029 |
| `_lifespan` | def | L3033–L3045 |
| `LockRequest` | class | L3051–L3053 |
| `lock_account` | def | L3057–L3096 |
| `PublishRequest` | class | L3099–L3101 |
| `publish_accounts` | def | L3105–L3134 |
| `hide_all_accounts` | def | L3138–L3153 |
| `pool_accounts` | def | L3157–L3175 |
| `api_pool_split` | def | L3179–L3193 |
| `api_pool_publish` | def | L3197–L3224 |
| `unlock_account` | def | L3228–L3246 |
| `_sse_generator` | def | L3249–L3278 |
| `events` | def | L3282–L3292 |
| `account_cards_pipe` | def | L3296–L3322 |
| `account_notes_summary` | def | L3326–L3351 |
| `_record_account_touch` | def | L3354–L3387 |
| `account_find_id` | def | L3391–L3397 |
| `account_refresh_api` | def | L3401–L3506 |
| `account_details` | def | L3510–L3901 |
| `NoteCreate` | class | L3904–L3905 |
| `create_note` | def | L3909–L3938 |
| `CurpUpdate` | class | L3941–L3942 |
| `update_curp` | def | L3946–L3957 |
| `get_clabes` | def | L3967–L3976 |
| `refresh_clabes` | def | L3980–L3990 |
| `_persist_withdrawal` | def | L3999–L4045 |
| `withdraw` | def | L4049–L4101 |
| `withdraw_status` | def | L4105–L4168 |
| `delete_note` | def | L4172–L4184 |
| `CombosRequest` | class | L4187–L4188 |
| `accounts_combos` | def | L4192–L4205 |
| `accounts_pass_map` | def | L4209–L4214 |
| `list_all_cards` | def | L4218–L4294 |
| `activity_feed` | def | L4298–L4395 |
| `list_deposits` | def | L4399–L4428 |
| `deposits_stats` | def | L4432–L4457 |
| `_persist_auto_mission` | def | L4465–L4496 |
| `admin_maintenance_state` | def | L4500–L4503 |
| `MaintenanceToggleRequest` | class | L4506–L4507 |
| `admin_maintenance_toggle` | def | L4511–L4534 |
| `auto_deposit_create` | def | L4538–L4590 |
| `auto_deposit_cancel` | def | L4594–L4620 |
| `emergency_stop_all_deposits` | def | L4624–L4655 |
| `operator_my_accounts` | def | L4659–L4749 |
| `operator_release_account` | def | L4753–L4770 |
| `operator_withdraw` | def | L4774–L4832 |
| `operator_auto_withdraw` | def | L4836–L4872 |
| `auto_deposit_confirm` | def | L4876–L4895 |
| `operator_missions` | def | L4899–L4917 |
| `operator_recent_ticker` | def | L4921–L5046 |
| `auto_deposit_status` | def | L5050–L5061 |
| `register_operator_strike` | def | L5064–L5097 |
| `bot_start_info` | def | L5101–L5137 |
| `bot_operator_info` | def | L5141–L5180 |
| `bot_help_info` | def | L5184–L5198 |
| `bot_pause_mission` | def | L5202–L5231 |
| `bot_resume_mission` | def | L5235–L5253 |
| `bot_cancel_mission` | def | L5258–L5293 |
| `bot_bet_create` | def | L5297–L5482 |
| `filter_and_sanitize_check_combos` | def | L5485–L5570 |
| `BotCheckRequest` | class | L5573–L5577 |
| `bot_check` | def | L5580–L5661 |
...
| `run_auto_mission` | def | L1613–L2819 |
