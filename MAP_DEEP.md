...
| `_migrate` | def | L229–L371 |
| `_backfill_grades_v10_m7` | def | L374–L445 |
| `_resolve_operator` | def | L451–L475 |
| `_is_sa` | def | L478–L480 |
| `_visible_emails` | def | L483–L505 |
| `_broadcast` | def | L512–L530 |
| `_dequeue_blocking` | def | L533–L538 |
| `_no_cache_static_assets` | def | L546–L558 |
| `favicon` | def | L566–L567 |
| `login_page` | def | L571–L574 |
| `_asset_mtimes` | def | L590–L597 |
| `_frontend_version` | def | L600–L604 |
| `index` | def | L608–L632 |
| `api_version` | def | L636–L646 |
| `auth_login` | def | L655–L686 |
| `auth_set_password` | def | L690–L714 |
| `auth_logout` | def | L718–L722 |
| `auth_me` | def | L726–L731 |
| `health` | def | L737–L743 |
| `_build_search_clause` | def | L746–L790 |
| `list_accounts` | def | L794–L910 |
| `list_users` | def | L916–L924 |
| `list_assignments` | def | L928–L949 |
| `AssignRequest` | class | L952–L954 |
| `assign_accounts` | def | L958–L977 |
| `unassign_accounts` | def | L981–L992 |
| `stats` | def | L996–L1003 |
| `_wsai_status` | def | L1018–L1043 |
| `_maybe_alert_broadcast` | def | L1050–L1067 |
| `_check_one_proxy` | def | L1070–L1096 |
| `_proxy_health` | def | L1099–L1148 |
| `_capmonster_balance` | def | L1151–L1171 |
| `_operator_color` | def | L1176–L1191 |
| `_resolve_who` | def | L1194–L1207 |
| `_event_visible_to` | def | L1210–L1236 |
| `superadmin_kpis` | def | L1240–L1483 |
| `RefreshRequest` | class | L1488–L1489 |
| `accounts_refresh` | def | L1493–L1512 |
| `get_logs` | def | L1518–L1543 |
| `_run_health_checks` | def | L1551–L1587 |
| `health_full` | def | L1591–L1592 |
| `_require_sa` | def | L1600–L1602 |
| `admin_diag` | def | L1606–L1637 |
| `admin_ping` | def | L1641–L1662 |
| `admin_refresh_proxy` | def | L1666–L1673 |
| `admin_services_restart` | def | L1677–L1691 |
| `admin_export_logs` | def | L1695–L1707 |
| `admin_pause_state` | def | L1715–L1717 |
| `admin_pause` | def | L1721–L1733 |
| `admin_resume` | def | L1737–L1743 |
| `admin_emergency_stop` | def | L1747–L1782 |
| `admin_vps_reboot` | def | L1786–L1798 |
| `health_last` | def | L1802–L1803 |
| `health_dismiss` | def | L1807–L1810 |
| `api_marks_list` | def | L1814–L1821 |
| `api_marks_toggle` | def | L1825–L1843 |
| `api_recent` | def | L1847–L1919 |
| `api_accounts_at_hand` | def | L1923–L2031 |
| `_health_loop` | def | L2034–L2044 |
| `_release_account` | def | L2047–L2068 |
| `_run_lock_janitor` | def | L2071–L2119 |
| `_janitor_loop` | def | L2122–L2132 |
| `_run_window_watcher` | def | L2141–L2213 |
| `_window_watcher_loop` | def | L2216–L2225 |
| `_release_watchdog_tick` | def | L2228–L2327 |
| `_release_watchdog_loop` | def | L2330–L2338 |
| `_jwt_keepalive_loop` | def | L2341–L2358 |
| `_account_refresh_loop` | def | L2361–L2379 |
| `_start_bg_tasks` | def | L2383–L2389 |
| `LockRequest` | class | L2392–L2394 |
| `lock_account` | def | L2398–L2437 |
| `PublishRequest` | class | L2440–L2442 |
| `publish_accounts` | def | L2446–L2475 |
| `hide_all_accounts` | def | L2479–L2494 |
| `pool_accounts` | def | L2498–L2516 |
| `api_pool_split` | def | L2520–L2534 |
| `api_pool_publish` | def | L2538–L2572 |
| `unlock_account` | def | L2576–L2594 |
| `_sse_generator` | def | L2597–L2623 |
| `events` | def | L2627–L2637 |
| `account_cards_pipe` | def | L2641–L2667 |
| `account_notes_summary` | def | L2671–L2696 |
| `_record_account_touch` | def | L2699–L2732 |
| `account_details` | def | L2736–L3060 |
| `NoteCreate` | class | L3063–L3064 |
| `create_note` | def | L3068–L3097 |
| `CurpUpdate` | class | L3100–L3101 |
| `update_curp` | def | L3105–L3116 |
| `get_clabes` | def | L3126–L3135 |
...
| `_set_account_cooldown` | def | L65–L78 |
| `_cooldown_remaining_min` | def | L81–L87 |
| `_is_transient_gateway_error` | def | L90–L100 |
| `_drain_stale_tokens` | def | L130–L162 |
| `_ensure_fresh_captcha` | def | L165–L189 |
| `_record_bin_3ds` | def | L197–L225 |
| `_bin_3ds_stats` | def | L228–L250 |
| `bin_check` | def | L254–L259 |
| `bin_stats_overview` | def | L263–L322 |
| `_auto_lock_for_deposit` | def | L325–L380 |
| `_window_status` | def | L383–L425 |
| `_check_caps` | def | L428–L441 |
| `_load_deps` | def | L444–L455 |
| `_parse_pipe` | def | L458–L479 |
| `_check_card_velocity` | def | L499–L546 |
| `_record_attempt` | def | L549–L669 |
| `_safe_phase` | def | L679–L686 |
| `_now_mx_str` | def | L694–L703 |
| `_deposit_step_payload` | def | L712–L720 |
| `_wrap_deposit_step` | def | L723–L742 |
| `_build_admin_proxy_url` | def | L745–L749 |
| `_refresh_account_after_deposit` | def | L752–L811 |
| `_should_relogin_after_401` | def | L814–L818 |
| `_acquire_session_and_begin` | def | L821–L1069 |
| `_run_deposit_with_phases` | def | L1072–L1386 |
| `deposit_execute_stream` | def | L1390–L1590 |
| `cap_status` | def | L1594–L1606 |
| `_mm_is_real_decline` | def | L1643–L1649 |
| `_mm_is_ambiguous_charge` | def | L1652–L1662 |
| `classify_deposit_status` | def | L1665–L1696 |
| `_mm_session_get` | def | L1746–L1750 |
| `_mm_session_update` | def | L1753–L1762 |
| `multi_stream` | def | L1766–L2263 |
| `multi_cancel` | def | L2267–L2272 |
| `scheduled_create` | def | L2285–L2648 |
| `scheduled_list` | def | L2652–L2674 |
| `scheduled_cancel` | def | L2678–L2686 |
