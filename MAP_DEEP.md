...
| `list_accounts` | def | L657–L772 |
| `list_users` | def | L778–L786 |
| `list_assignments` | def | L790–L811 |
| `AssignRequest` | class | L814–L816 |
| `assign_accounts` | def | L820–L839 |
| `unassign_accounts` | def | L843–L854 |
| `stats` | def | L858–L865 |
| `_wsai_status` | def | L880–L905 |
| `_maybe_alert_broadcast` | def | L912–L929 |
| `_check_one_proxy` | def | L932–L958 |
| `_proxy_health` | def | L961–L1010 |
| `_capmonster_balance` | def | L1013–L1033 |
| `_operator_color` | def | L1038–L1053 |
| `_resolve_who` | def | L1056–L1069 |
| `_event_visible_to` | def | L1072–L1098 |
| `superadmin_kpis` | def | L1102–L1345 |
| `RefreshRequest` | class | L1350–L1351 |
| `accounts_refresh` | def | L1355–L1374 |
| `get_logs` | def | L1380–L1405 |
| `_run_health_checks` | def | L1413–L1449 |
| `health_full` | def | L1453–L1454 |
| `_require_sa` | def | L1462–L1464 |
| `admin_diag` | def | L1468–L1499 |
| `admin_ping` | def | L1503–L1524 |
| `admin_refresh_proxy` | def | L1528–L1535 |
| `admin_services_restart` | def | L1539–L1553 |
| `admin_export_logs` | def | L1557–L1569 |
| `admin_pause_state` | def | L1577–L1579 |
| `admin_pause` | def | L1583–L1595 |
| `admin_resume` | def | L1599–L1605 |
| `admin_emergency_stop` | def | L1609–L1644 |
| `admin_vps_reboot` | def | L1648–L1660 |
| `health_last` | def | L1664–L1665 |
| `health_dismiss` | def | L1669–L1672 |
| `api_marks_list` | def | L1676–L1683 |
| `api_marks_toggle` | def | L1687–L1705 |
| `api_recent` | def | L1709–L1781 |
| `api_accounts_at_hand` | def | L1785–L1893 |
| `_health_loop` | def | L1896–L1906 |
| `_release_account` | def | L1909–L1930 |
| `_run_lock_janitor` | def | L1933–L1981 |
| `_janitor_loop` | def | L1984–L1994 |
| `_run_window_watcher` | def | L2003–L2075 |
| `_window_watcher_loop` | def | L2078–L2087 |
| `_release_watchdog_tick` | def | L2090–L2189 |
| `_release_watchdog_loop` | def | L2192–L2200 |
| `_jwt_keepalive_loop` | def | L2203–L2220 |
| `_start_bg_tasks` | def | L2224–L2229 |
| `LockRequest` | class | L2232–L2234 |
| `lock_account` | def | L2238–L2277 |
| `PublishRequest` | class | L2280–L2282 |
| `publish_accounts` | def | L2286–L2309 |
| `hide_all_accounts` | def | L2313–L2325 |
| `pool_accounts` | def | L2329–L2347 |
| `api_pool_split` | def | L2351–L2365 |
| `api_pool_publish` | def | L2369–L2401 |
| `unlock_account` | def | L2405–L2423 |
| `_sse_generator` | def | L2426–L2452 |
| `events` | def | L2456–L2466 |
| `account_cards_pipe` | def | L2470–L2496 |
| `account_notes_summary` | def | L2500–L2525 |
| `account_details` | def | L2529–L2830 |
| `NoteCreate` | class | L2833–L2834 |
| `create_note` | def | L2838–L2867 |
| `CurpUpdate` | class | L2870–L2871 |
| `update_curp` | def | L2875–L2886 |
| `delete_note` | def | L2890–L2902 |
| `CombosRequest` | class | L2905–L2906 |
| `accounts_combos` | def | L2910–L2923 |
| `accounts_pass_map` | def | L2927–L2932 |
| `list_all_cards` | def | L2936–L3011 |
| `activity_feed` | def | L3015–L3136 |
| `list_deposits` | def | L3140–L3169 |
| `deposits_stats` | def | L3173–L3198 |
