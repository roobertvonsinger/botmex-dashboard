...
| `_maintenance_gate_middleware` | def | L596–L622 |
| `_no_cache_static_assets` | def | L626–L638 |
| `favicon` | def | L646–L647 |
| `maintenance_page` | def | L651–L652 |
| `login_page` | def | L656–L659 |
| `_asset_mtimes` | def | L675–L682 |
| `_frontend_version` | def | L685–L689 |
| `index` | def | L693–L717 |
| `api_version` | def | L721–L731 |
| `auth_login` | def | L740–L771 |
| `auth_set_password` | def | L775–L799 |
| `auth_logout` | def | L803–L807 |
| `auth_me` | def | L811–L816 |
| `health` | def | L822–L828 |
| `_build_search_clause` | def | L831–L875 |
| `list_accounts` | def | L879–L999 |
| `list_users` | def | L1005–L1013 |
| `list_assignments` | def | L1017–L1038 |
| `AssignRequest` | class | L1041–L1043 |
| `assign_accounts` | def | L1047–L1066 |
| `unassign_accounts` | def | L1070–L1081 |
| `stats` | def | L1085–L1092 |
| `_wsai_status` | def | L1107–L1132 |
| `_maybe_alert_broadcast` | def | L1139–L1156 |
| `_check_one_proxy` | def | L1159–L1185 |
| `_proxy_health` | def | L1188–L1237 |
| `_capmonster_balance` | def | L1240–L1260 |
| `_operator_color` | def | L1265–L1280 |
| `_resolve_who` | def | L1283–L1296 |
| `_event_visible_to` | def | L1299–L1325 |
| `superadmin_kpis` | def | L1329–L1572 |
| `RefreshRequest` | class | L1577–L1578 |
| `accounts_refresh` | def | L1582–L1601 |
| `get_logs` | def | L1622–L1657 |
| `_run_health_checks` | def | L1665–L1701 |
| `health_full` | def | L1705–L1706 |
| `_require_sa` | def | L1714–L1716 |
| `admin_diag` | def | L1720–L1751 |
| `admin_ping` | def | L1755–L1776 |
| `admin_refresh_proxy` | def | L1780–L1787 |
| `admin_services_restart` | def | L1791–L1805 |
| `admin_export_logs` | def | L1809–L1821 |
| `admin_pause_state` | def | L1829–L1831 |
| `admin_pause` | def | L1835–L1847 |
| `admin_resume` | def | L1851–L1857 |
| `admin_emergency_stop` | def | L1861–L1896 |
| `admin_vps_reboot` | def | L1900–L1912 |
| `health_last` | def | L1916–L1917 |
| `health_dismiss` | def | L1921–L1924 |
| `api_marks_list` | def | L1928–L1935 |
| `api_marks_toggle` | def | L1939–L1957 |
| `api_recent` | def | L1961–L2033 |
| `api_accounts_at_hand` | def | L2037–L2145 |
| `_health_loop` | def | L2148–L2158 |
| `_release_account` | def | L2161–L2182 |
| `_run_lock_janitor` | def | L2185–L2233 |
| `_janitor_loop` | def | L2236–L2246 |
| `_run_window_watcher` | def | L2255–L2327 |
| `_window_watcher_loop` | def | L2330–L2339 |
| `_release_watchdog_tick` | def | L2342–L2441 |
| `_release_watchdog_loop` | def | L2444–L2452 |
| `_jwt_keepalive_loop` | def | L2455–L2472 |
| `_account_refresh_loop` | def | L2475–L2493 |
| `_start_bg_tasks` | def | L2497–L2503 |
| `LockRequest` | class | L2506–L2508 |
| `lock_account` | def | L2512–L2551 |
| `PublishRequest` | class | L2554–L2556 |
| `publish_accounts` | def | L2560–L2589 |
| `hide_all_accounts` | def | L2593–L2608 |
| `pool_accounts` | def | L2612–L2630 |
| `api_pool_split` | def | L2634–L2648 |
| `api_pool_publish` | def | L2652–L2686 |
| `unlock_account` | def | L2690–L2708 |
| `_sse_generator` | def | L2711–L2737 |
| `events` | def | L2741–L2751 |
| `account_cards_pipe` | def | L2755–L2781 |
| `account_notes_summary` | def | L2785–L2810 |
| `_record_account_touch` | def | L2813–L2846 |
| `account_details` | def | L2850–L3190 |
| `NoteCreate` | class | L3193–L3194 |
| `create_note` | def | L3198–L3227 |
| `CurpUpdate` | class | L3230–L3231 |
| `update_curp` | def | L3235–L3246 |
| `get_clabes` | def | L3256–L3265 |
| `refresh_clabes` | def | L3269–L3279 |
| `_persist_withdrawal` | def | L3288–L3334 |
| `withdraw` | def | L3338–L3383 |
| `withdraw_status` | def | L3387–L3544 |
| `delete_note` | def | L3548–L3560 |
| `CombosRequest` | class | L3563–L3564 |
| `accounts_combos` | def | L3568–L3581 |
| `accounts_pass_map` | def | L3585–L3590 |
| `list_all_cards` | def | L3594–L3669 |
| `activity_feed` | def | L3673–L3770 |
| `list_deposits` | def | L3774–L3803 |
| `deposits_stats` | def | L3807–L3832 |
| `_persist_auto_mission` | def | L3840–L3870 |
| `auto_deposit_create` | def | L3874–L3910 |
| `auto_deposit_cancel` | def | L3914–L3940 |
| `auto_deposit_status` | def | L3944–L3955 |
