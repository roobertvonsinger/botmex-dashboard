...
| `_migrate` | def | L229–L435 |
| `_backfill_grades_v10_m7` | def | L438–L509 |
| `_resolve_operator` | def | L515–L539 |
| `_is_sa` | def | L542–L544 |
| `_visible_emails` | def | L547–L569 |
| `_broadcast` | def | L576–L594 |
| `_dequeue_blocking` | def | L597–L602 |
| `_is_maintenance_active` | def | L611–L614 |
| `_maintenance_gate_middleware` | def | L617–L642 |
| `_no_cache_static_assets` | def | L646–L658 |
| `favicon` | def | L666–L667 |
| `maintenance_page` | def | L671–L672 |
| `login_page` | def | L676–L679 |
| `_asset_mtimes` | def | L695–L702 |
| `_frontend_version` | def | L705–L709 |
| `index` | def | L713–L737 |
| `api_version` | def | L741–L751 |
| `auth_login` | def | L760–L791 |
| `auth_set_password` | def | L795–L819 |
| `auth_logout` | def | L823–L827 |
| `auth_me` | def | L831–L836 |
| `health` | def | L842–L848 |
| `_build_search_clause` | def | L851–L895 |
| `list_accounts` | def | L899–L1019 |
| `list_users` | def | L1025–L1033 |
| `list_assignments` | def | L1037–L1058 |
| `AssignRequest` | class | L1061–L1063 |
| `assign_accounts` | def | L1067–L1086 |
| `unassign_accounts` | def | L1090–L1101 |
| `stats` | def | L1105–L1112 |
| `_wsai_status` | def | L1127–L1152 |
| `_maybe_alert_broadcast` | def | L1159–L1176 |
| `_check_one_proxy` | def | L1179–L1205 |
| `_proxy_health` | def | L1208–L1257 |
| `_capmonster_balance` | def | L1260–L1280 |
| `_operator_color` | def | L1285–L1300 |
| `_resolve_who` | def | L1303–L1316 |
| `_event_visible_to` | def | L1319–L1345 |
| `superadmin_kpis` | def | L1349–L1592 |
| `RefreshRequest` | class | L1597–L1598 |
| `accounts_refresh` | def | L1602–L1621 |
| `get_logs` | def | L1642–L1677 |
| `_run_health_checks` | def | L1685–L1721 |
| `health_full` | def | L1725–L1726 |
| `_require_sa` | def | L1734–L1736 |
| `admin_diag` | def | L1740–L1771 |
| `admin_ping` | def | L1775–L1796 |
| `admin_refresh_proxy` | def | L1800–L1807 |
| `admin_services_restart` | def | L1811–L1825 |
| `admin_export_logs` | def | L1829–L1841 |
| `admin_pause_state` | def | L1849–L1851 |
| `admin_pause` | def | L1855–L1867 |
| `admin_resume` | def | L1871–L1877 |
| `admin_emergency_stop` | def | L1881–L1916 |
| `admin_vps_reboot` | def | L1920–L1932 |
| `health_last` | def | L1936–L1937 |
| `health_dismiss` | def | L1941–L1944 |
| `api_marks_list` | def | L1948–L1955 |
| `api_marks_toggle` | def | L1959–L1977 |
| `api_recent` | def | L1981–L2053 |
| `api_accounts_at_hand` | def | L2057–L2165 |
| `_health_loop` | def | L2168–L2178 |
| `_release_account` | def | L2181–L2202 |
| `_run_lock_janitor` | def | L2205–L2253 |
| `_janitor_loop` | def | L2256–L2266 |
| `_run_window_watcher` | def | L2275–L2347 |
| `_window_watcher_loop` | def | L2350–L2359 |
| `_release_watchdog_tick` | def | L2362–L2461 |
| `_release_watchdog_loop` | def | L2464–L2472 |
| `_jwt_keepalive_loop` | def | L2475–L2492 |
| `_account_refresh_loop` | def | L2495–L2513 |
| `_startup_telegram_notify` | def | L2516–L2538 |
| `_start_bg_tasks` | def | L2542–L2549 |
| `LockRequest` | class | L2552–L2554 |
| `lock_account` | def | L2558–L2597 |
| `PublishRequest` | class | L2600–L2602 |
| `publish_accounts` | def | L2606–L2635 |
| `hide_all_accounts` | def | L2639–L2654 |
| `pool_accounts` | def | L2658–L2676 |
| `api_pool_split` | def | L2680–L2694 |
| `api_pool_publish` | def | L2698–L2732 |
| `unlock_account` | def | L2736–L2754 |
| `_sse_generator` | def | L2757–L2783 |
| `events` | def | L2787–L2797 |
| `account_cards_pipe` | def | L2801–L2827 |
| `account_notes_summary` | def | L2831–L2856 |
| `_record_account_touch` | def | L2859–L2892 |
| `account_details` | def | L2896–L3236 |
| `NoteCreate` | class | L3239–L3240 |
| `create_note` | def | L3244–L3273 |
| `CurpUpdate` | class | L3276–L3277 |
| `update_curp` | def | L3281–L3292 |
| `get_clabes` | def | L3302–L3311 |
| `refresh_clabes` | def | L3315–L3325 |
| `_persist_withdrawal` | def | L3334–L3380 |
| `withdraw` | def | L3384–L3429 |
| `withdraw_status` | def | L3433–L3590 |
| `delete_note` | def | L3594–L3606 |
| `CombosRequest` | class | L3609–L3610 |
| `accounts_combos` | def | L3614–L3627 |
| `accounts_pass_map` | def | L3631–L3636 |
| `list_all_cards` | def | L3640–L3715 |
| `activity_feed` | def | L3719–L3816 |
| `list_deposits` | def | L3820–L3849 |
| `deposits_stats` | def | L3853–L3878 |
| `_persist_auto_mission` | def | L3886–L3916 |
| `admin_maintenance_state` | def | L3920–L3923 |
| `MaintenanceToggleRequest` | class | L3926–L3927 |
| `admin_maintenance_toggle` | def | L3931–L3952 |
| `auto_deposit_create` | def | L3956–L3992 |
| `auto_deposit_cancel` | def | L3996–L4022 |
| `auto_deposit_status` | def | L4026–L4037 |
| `bot_bet_create` | def | L4041–L4210 |
