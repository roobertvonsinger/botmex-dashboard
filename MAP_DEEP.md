...
|---------|------|--------|
| `db` | def | L124–L138 |
| `_migrate` | def | L141–L253 |
| `_backfill_grades_v10_m7` | def | L256–L327 |
| `_resolve_operator` | def | L333–L357 |
| `_is_sa` | def | L360–L362 |
| `_visible_emails` | def | L365–L387 |
| `_broadcast` | def | L394–L412 |
| `_dequeue_blocking` | def | L415–L420 |
| `_no_cache_static_assets` | def | L428–L440 |
| `favicon` | def | L448–L449 |
| `login_page` | def | L453–L456 |
| `_asset_mtimes` | def | L472–L479 |
| `_frontend_version` | def | L482–L486 |
| `index` | def | L490–L514 |
| `api_version` | def | L518–L528 |
| `auth_login` | def | L537–L568 |
| `auth_set_password` | def | L572–L596 |
| `auth_logout` | def | L600–L604 |
| `auth_me` | def | L608–L613 |
| `health` | def | L619–L625 |
| `_build_search_clause` | def | L628–L672 |
| `list_accounts` | def | L676–L792 |
| `list_users` | def | L798–L806 |
| `list_assignments` | def | L810–L831 |
| `AssignRequest` | class | L834–L836 |
| `assign_accounts` | def | L840–L859 |
| `unassign_accounts` | def | L863–L874 |
| `stats` | def | L878–L885 |
| `_wsai_status` | def | L900–L925 |
| `_maybe_alert_broadcast` | def | L932–L949 |
| `_check_one_proxy` | def | L952–L978 |
| `_proxy_health` | def | L981–L1030 |
| `_capmonster_balance` | def | L1033–L1053 |
| `_operator_color` | def | L1058–L1073 |
| `_resolve_who` | def | L1076–L1089 |
| `_event_visible_to` | def | L1092–L1118 |
| `superadmin_kpis` | def | L1122–L1365 |
| `RefreshRequest` | class | L1370–L1371 |
| `accounts_refresh` | def | L1375–L1394 |
| `get_logs` | def | L1400–L1425 |
| `_run_health_checks` | def | L1433–L1469 |
| `health_full` | def | L1473–L1474 |
| `_require_sa` | def | L1482–L1484 |
| `admin_diag` | def | L1488–L1519 |
| `admin_ping` | def | L1523–L1544 |
| `admin_refresh_proxy` | def | L1548–L1555 |
| `admin_services_restart` | def | L1559–L1573 |
| `admin_export_logs` | def | L1577–L1589 |
| `admin_pause_state` | def | L1597–L1599 |
| `admin_pause` | def | L1603–L1615 |
| `admin_resume` | def | L1619–L1625 |
| `admin_emergency_stop` | def | L1629–L1664 |
| `admin_vps_reboot` | def | L1668–L1680 |
| `health_last` | def | L1684–L1685 |
| `health_dismiss` | def | L1689–L1692 |
| `api_marks_list` | def | L1696–L1703 |
| `api_marks_toggle` | def | L1707–L1725 |
| `api_recent` | def | L1729–L1801 |
| `api_accounts_at_hand` | def | L1805–L1913 |
| `_health_loop` | def | L1916–L1926 |
| `_release_account` | def | L1929–L1950 |
| `_run_lock_janitor` | def | L1953–L2001 |
| `_janitor_loop` | def | L2004–L2014 |
| `_run_window_watcher` | def | L2023–L2095 |
| `_window_watcher_loop` | def | L2098–L2107 |
| `_release_watchdog_tick` | def | L2110–L2209 |
| `_release_watchdog_loop` | def | L2212–L2220 |
| `_jwt_keepalive_loop` | def | L2223–L2240 |
| `_account_refresh_loop` | def | L2243–L2261 |
| `_start_bg_tasks` | def | L2265–L2271 |
| `LockRequest` | class | L2274–L2276 |
| `lock_account` | def | L2280–L2319 |
| `PublishRequest` | class | L2322–L2324 |
| `publish_accounts` | def | L2328–L2357 |
| `hide_all_accounts` | def | L2361–L2376 |
| `pool_accounts` | def | L2380–L2398 |
| `api_pool_split` | def | L2402–L2416 |
| `api_pool_publish` | def | L2420–L2454 |
| `unlock_account` | def | L2458–L2476 |
| `_sse_generator` | def | L2479–L2505 |
| `events` | def | L2509–L2519 |
| `account_cards_pipe` | def | L2523–L2549 |
| `account_notes_summary` | def | L2553–L2578 |
| `account_details` | def | L2582–L2898 |
| `NoteCreate` | class | L2901–L2902 |
| `create_note` | def | L2906–L2935 |
| `CurpUpdate` | class | L2938–L2939 |
| `update_curp` | def | L2943–L2954 |
| `get_clabes` | def | L2964–L2973 |
| `refresh_clabes` | def | L2977–L2987 |
| `delete_note` | def | L2991–L3003 |
| `CombosRequest` | class | L3006–L3007 |
| `accounts_combos` | def | L3011–L3024 |
| `accounts_pass_map` | def | L3028–L3033 |
| `list_all_cards` | def | L3037–L3112 |
| `activity_feed` | def | L3116–L3237 |
| `list_deposits` | def | L3241–L3270 |
| `deposits_stats` | def | L3274–L3299 |
