...
| `_tail_log_file` | def | L1823–L1851 |
| `get_logs` | def | L1855–L1865 |
| `get_logs_telegram` | def | L1875–L1890 |
| `_run_health_checks` | def | L1898–L1934 |
| `health_full` | def | L1938–L1939 |
| `_require_sa` | def | L1947–L1949 |
| `admin_diag` | def | L1953–L1984 |
| `admin_ping` | def | L1988–L2009 |
| `admin_refresh_proxy` | def | L2013–L2020 |
| `admin_services_restart` | def | L2024–L2045 |
| `admin_export_logs` | def | L2049–L2065 |
| `admin_pause_state` | def | L2073–L2075 |
| `admin_pause` | def | L2079–L2091 |
| `admin_resume` | def | L2095–L2101 |
| `admin_emergency_stop` | def | L2105–L2140 |
| `admin_vps_reboot` | def | L2144–L2156 |
| `health_last` | def | L2160–L2161 |
| `health_dismiss` | def | L2165–L2168 |
| `api_marks_list` | def | L2172–L2179 |
| `api_marks_toggle` | def | L2183–L2201 |
| `api_recent` | def | L2205–L2277 |
| `api_accounts_at_hand` | def | L2281–L2389 |
| `_health_loop` | def | L2392–L2402 |
| `_release_account` | def | L2405–L2426 |
| `_run_lock_janitor` | def | L2429–L2477 |
| `_janitor_loop` | def | L2480–L2490 |
| `_run_window_watcher` | def | L2499–L2571 |
| `_window_watcher_loop` | def | L2574–L2583 |
| `_release_watchdog_tick` | def | L2586–L2685 |
| `_release_watchdog_loop` | def | L2688–L2696 |
| `_jwt_keepalive_loop` | def | L2699–L2727 |
| `_wake_jwt_keeper` | def | L2734–L2745 |
| `_account_refresh_loop` | def | L2748–L2766 |
| `_bot_token` | def | L2772–L2781 |
| `_notify_robert` | def | L2784–L2799 |
| `_startup_telegram_notify` | def | L2802–L2826 |
| `_lifespan` | def | L2830–L2839 |
| `LockRequest` | class | L2845–L2847 |
| `lock_account` | def | L2851–L2890 |
| `PublishRequest` | class | L2893–L2895 |
| `publish_accounts` | def | L2899–L2928 |
| `hide_all_accounts` | def | L2932–L2947 |
| `pool_accounts` | def | L2951–L2969 |
| `api_pool_split` | def | L2973–L2987 |
| `api_pool_publish` | def | L2991–L3025 |
| `unlock_account` | def | L3029–L3047 |
| `_sse_generator` | def | L3050–L3076 |
| `events` | def | L3080–L3090 |
| `account_cards_pipe` | def | L3094–L3120 |
| `account_notes_summary` | def | L3124–L3149 |
| `_record_account_touch` | def | L3152–L3185 |
| `account_find_id` | def | L3189–L3195 |
| `account_details` | def | L3199–L3579 |
| `NoteCreate` | class | L3582–L3583 |
| `create_note` | def | L3587–L3616 |
| `CurpUpdate` | class | L3619–L3620 |
| `update_curp` | def | L3624–L3635 |
| `get_clabes` | def | L3645–L3654 |
| `refresh_clabes` | def | L3658–L3668 |
| `_persist_withdrawal` | def | L3677–L3723 |
| `withdraw` | def | L3727–L3779 |
| `withdraw_status` | def | L3783–L3943 |
| `delete_note` | def | L3947–L3959 |
| `CombosRequest` | class | L3962–L3963 |
| `accounts_combos` | def | L3967–L3980 |
| `accounts_pass_map` | def | L3984–L3989 |
| `list_all_cards` | def | L3993–L4069 |
| `activity_feed` | def | L4073–L4170 |
| `list_deposits` | def | L4174–L4203 |
| `deposits_stats` | def | L4207–L4232 |
| `_persist_auto_mission` | def | L4240–L4270 |
| `admin_maintenance_state` | def | L4274–L4277 |
| `MaintenanceToggleRequest` | class | L4280–L4281 |
| `admin_maintenance_toggle` | def | L4285–L4306 |
| `auto_deposit_create` | def | L4310–L4346 |
| `auto_deposit_cancel` | def | L4350–L4376 |
| `operator_my_accounts` | def | L4380–L4449 |
| `operator_release_account` | def | L4453–L4470 |
| `operator_withdraw` | def | L4474–L4532 |
| `operator_missions` | def | L4536–L4554 |
| `auto_deposit_status` | def | L4558–L4569 |
| `register_operator_strike` | def | L4572–L4605 |
| `bot_start_info` | def | L4609–L4645 |
| `bot_operator_info` | def | L4649–L4688 |
| `bot_help_info` | def | L4692–L4706 |
| `bot_pause_mission` | def | L4710–L4739 |
| `bot_resume_mission` | def | L4743–L4761 |
| `bot_cancel_mission` | def | L4766–L4801 |
| `bot_bet_create` | def | L4805–L4974 |
| `filter_and_sanitize_check_combos` | def | L4977–L5062 |
| `BotCheckRequest` | class | L5065–L5069 |
| `bot_check` | def | L5072–L5153 |
