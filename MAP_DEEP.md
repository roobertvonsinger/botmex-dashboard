...
|---------|------|--------|
| `db` | def | L124–L138 |
| `_migrate` | def | L141–L221 |
| `_resolve_operator` | def | L227–L251 |
| `_is_sa` | def | L254–L256 |
| `_visible_emails` | def | L259–L281 |
| `_broadcast` | def | L288–L306 |
| `_dequeue_blocking` | def | L309–L314 |
| `_no_cache_static_assets` | def | L322–L334 |
| `favicon` | def | L342–L343 |
| `login_page` | def | L347–L350 |
| `_asset_mtimes` | def | L366–L373 |
| `_frontend_version` | def | L376–L380 |
| `index` | def | L384–L408 |
| `api_version` | def | L412–L422 |
| `auth_login` | def | L431–L462 |
| `auth_set_password` | def | L466–L490 |
| `auth_logout` | def | L494–L498 |
| `auth_me` | def | L502–L507 |
| `health` | def | L513–L519 |
| `_build_search_clause` | def | L522–L566 |
| `list_accounts` | def | L570–L659 |
| `list_users` | def | L665–L673 |
| `list_assignments` | def | L677–L698 |
| `AssignRequest` | class | L701–L703 |
| `assign_accounts` | def | L707–L726 |
| `unassign_accounts` | def | L730–L741 |
| `stats` | def | L745–L752 |
| `_wsai_status` | def | L767–L792 |
| `_maybe_alert_broadcast` | def | L799–L816 |
| `_check_one_proxy` | def | L819–L845 |
| `_proxy_health` | def | L848–L897 |
| `_capmonster_balance` | def | L900–L920 |
| `_operator_color` | def | L925–L926 |
| `_resolve_who` | def | L929–L942 |
| `_event_visible_to` | def | L945–L971 |
| `superadmin_kpis` | def | L975–L1218 |
| `RefreshRequest` | class | L1223–L1224 |
| `accounts_refresh` | def | L1228–L1247 |
| `get_logs` | def | L1253–L1278 |
| `_run_health_checks` | def | L1286–L1322 |
| `health_full` | def | L1326–L1327 |
| `_require_sa` | def | L1335–L1337 |
| `admin_diag` | def | L1341–L1372 |
| `admin_ping` | def | L1376–L1397 |
| `admin_refresh_proxy` | def | L1401–L1408 |
| `admin_services_restart` | def | L1412–L1426 |
| `admin_export_logs` | def | L1430–L1442 |
| `admin_pause_state` | def | L1450–L1452 |
| `admin_pause` | def | L1456–L1468 |
| `admin_resume` | def | L1472–L1478 |
| `admin_emergency_stop` | def | L1482–L1517 |
| `admin_vps_reboot` | def | L1521–L1533 |
| `health_last` | def | L1537–L1538 |
| `health_dismiss` | def | L1542–L1545 |
| `api_marks_list` | def | L1549–L1556 |
| `api_marks_toggle` | def | L1560–L1578 |
| `api_recent` | def | L1582–L1654 |
| `api_accounts_at_hand` | def | L1658–L1766 |
| `_health_loop` | def | L1769–L1779 |
| `_release_account` | def | L1782–L1803 |
| `_run_lock_janitor` | def | L1806–L1854 |
| `_janitor_loop` | def | L1857–L1867 |
| `_run_window_watcher` | def | L1876–L1948 |
| `_window_watcher_loop` | def | L1951–L1960 |
| `_release_watchdog_tick` | def | L1963–L2062 |
| `_release_watchdog_loop` | def | L2065–L2073 |
| `_start_bg_tasks` | def | L2077–L2081 |
| `LockRequest` | class | L2084–L2086 |
| `lock_account` | def | L2090–L2129 |
| `PublishRequest` | class | L2132–L2134 |
| `publish_accounts` | def | L2138–L2161 |
| `hide_all_accounts` | def | L2165–L2177 |
| `pool_accounts` | def | L2181–L2199 |
| `api_pool_split` | def | L2203–L2217 |
| `api_pool_publish` | def | L2221–L2253 |
| `unlock_account` | def | L2257–L2275 |
| `_sse_generator` | def | L2278–L2304 |
| `events` | def | L2308–L2318 |
| `account_cards_pipe` | def | L2322–L2348 |
| `account_notes_summary` | def | L2352–L2377 |
| `account_details` | def | L2381–L2675 |
| `NoteCreate` | class | L2678–L2679 |
| `create_note` | def | L2683–L2712 |
| `CurpUpdate` | class | L2715–L2716 |
| `update_curp` | def | L2720–L2731 |
| `delete_note` | def | L2735–L2747 |
| `CombosRequest` | class | L2750–L2751 |
| `accounts_combos` | def | L2755–L2768 |
| `accounts_pass_map` | def | L2772–L2777 |
| `list_all_cards` | def | L2781–L2856 |
| `activity_feed` | def | L2860–L2981 |
| `list_deposits` | def | L2985–L3014 |
| `deposits_stats` | def | L3018–L3043 |
