...
| `_build_search_clause` | def | L423–L459 |
| `list_accounts` | def | L463–L552 |
| `list_users` | def | L558–L566 |
| `list_assignments` | def | L570–L591 |
| `AssignRequest` | class | L594–L596 |
| `assign_accounts` | def | L600–L619 |
| `unassign_accounts` | def | L623–L634 |
| `stats` | def | L638–L645 |
| `_wsai_status` | def | L660–L685 |
| `_maybe_alert_broadcast` | def | L692–L709 |
| `_check_one_proxy` | def | L712–L738 |
| `_proxy_health` | def | L741–L790 |
| `_capmonster_balance` | def | L793–L813 |
| `_operator_color` | def | L818–L819 |
| `_resolve_who` | def | L822–L830 |
| `superadmin_kpis` | def | L834–L1077 |
| `RefreshRequest` | class | L1082–L1083 |
| `accounts_refresh` | def | L1087–L1106 |
| `get_logs` | def | L1112–L1137 |
| `_run_health_checks` | def | L1145–L1181 |
| `health_full` | def | L1185–L1186 |
| `_require_sa` | def | L1194–L1196 |
| `admin_diag` | def | L1200–L1231 |
| `admin_ping` | def | L1235–L1256 |
| `admin_refresh_proxy` | def | L1260–L1267 |
| `admin_services_restart` | def | L1271–L1285 |
| `admin_export_logs` | def | L1289–L1301 |
| `admin_pause_state` | def | L1309–L1311 |
| `admin_pause` | def | L1315–L1327 |
| `admin_resume` | def | L1331–L1337 |
| `admin_emergency_stop` | def | L1341–L1376 |
| `admin_vps_reboot` | def | L1380–L1392 |
| `health_last` | def | L1396–L1397 |
| `health_dismiss` | def | L1401–L1404 |
| `_health_loop` | def | L1407–L1417 |
| `_release_account` | def | L1420–L1440 |
| `_run_lock_janitor` | def | L1443–L1491 |
| `_janitor_loop` | def | L1494–L1504 |
| `_run_window_watcher` | def | L1513–L1585 |
| `_window_watcher_loop` | def | L1588–L1597 |
| `_release_watchdog_tick` | def | L1600–L1699 |
| `_release_watchdog_loop` | def | L1702–L1710 |
| `_start_bg_tasks` | def | L1714–L1718 |
| `LockRequest` | class | L1721–L1723 |
| `lock_account` | def | L1727–L1766 |
| `PublishRequest` | class | L1769–L1771 |
| `publish_accounts` | def | L1775–L1798 |
| `hide_all_accounts` | def | L1802–L1814 |
| `pool_accounts` | def | L1818–L1836 |
| `unlock_account` | def | L1840–L1858 |
| `_sse_generator` | def | L1861–L1888 |
| `events` | def | L1892–L1897 |
| `account_cards_pipe` | def | L1901–L1927 |
| `account_notes_summary` | def | L1931–L1956 |
| `account_details` | def | L1960–L2171 |
| `NoteCreate` | class | L2174–L2175 |
| `create_note` | def | L2179–L2208 |
| `CurpUpdate` | class | L2211–L2212 |
| `update_curp` | def | L2216–L2227 |
| `delete_note` | def | L2231–L2243 |
| `CombosRequest` | class | L2246–L2247 |
| `accounts_combos` | def | L2251–L2264 |
| `accounts_pass_map` | def | L2268–L2273 |
| `list_all_cards` | def | L2277–L2352 |
| `activity_feed` | def | L2356–L2473 |
| `list_deposits` | def | L2477–L2506 |
| `deposits_stats` | def | L2510–L2535 |
