...
| `list_accounts` | def | L899–L1021 |
| `list_users` | def | L1027–L1035 |
| `list_assignments` | def | L1039–L1060 |
| `AssignRequest` | class | L1063–L1065 |
| `assign_accounts` | def | L1069–L1088 |
| `unassign_accounts` | def | L1092–L1103 |
| `stats` | def | L1107–L1114 |
| `_wsai_status` | def | L1129–L1154 |
| `_maybe_alert_broadcast` | def | L1161–L1178 |
| `_check_one_proxy` | def | L1181–L1207 |
| `_proxy_health` | def | L1210–L1259 |
| `_capmonster_balance` | def | L1262–L1282 |
| `_operator_color` | def | L1287–L1302 |
| `_resolve_who` | def | L1305–L1318 |
| `_event_visible_to` | def | L1321–L1347 |
| `superadmin_kpis` | def | L1351–L1594 |
| `RefreshRequest` | class | L1599–L1600 |
| `accounts_refresh` | def | L1604–L1623 |
| `get_logs` | def | L1644–L1679 |
| `_run_health_checks` | def | L1687–L1723 |
| `health_full` | def | L1727–L1728 |
| `_require_sa` | def | L1736–L1738 |
| `admin_diag` | def | L1742–L1773 |
| `admin_ping` | def | L1777–L1798 |
| `admin_refresh_proxy` | def | L1802–L1809 |
| `admin_services_restart` | def | L1813–L1827 |
| `admin_export_logs` | def | L1831–L1843 |
| `admin_pause_state` | def | L1851–L1853 |
| `admin_pause` | def | L1857–L1869 |
| `admin_resume` | def | L1873–L1879 |
| `admin_emergency_stop` | def | L1883–L1918 |
| `admin_vps_reboot` | def | L1922–L1934 |
| `health_last` | def | L1938–L1939 |
| `health_dismiss` | def | L1943–L1946 |
| `api_marks_list` | def | L1950–L1957 |
| `api_marks_toggle` | def | L1961–L1979 |
| `api_recent` | def | L1983–L2055 |
| `api_accounts_at_hand` | def | L2059–L2167 |
| `_health_loop` | def | L2170–L2180 |
| `_release_account` | def | L2183–L2204 |
| `_run_lock_janitor` | def | L2207–L2255 |
| `_janitor_loop` | def | L2258–L2268 |
| `_run_window_watcher` | def | L2277–L2349 |
| `_window_watcher_loop` | def | L2352–L2361 |
| `_release_watchdog_tick` | def | L2364–L2463 |
| `_release_watchdog_loop` | def | L2466–L2474 |
| `_jwt_keepalive_loop` | def | L2477–L2494 |
| `_account_refresh_loop` | def | L2497–L2515 |
| `_startup_telegram_notify` | def | L2518–L2540 |
| `_start_bg_tasks` | def | L2544–L2551 |
| `LockRequest` | class | L2554–L2556 |
| `lock_account` | def | L2560–L2599 |
| `PublishRequest` | class | L2602–L2604 |
| `publish_accounts` | def | L2608–L2637 |
| `hide_all_accounts` | def | L2641–L2656 |
| `pool_accounts` | def | L2660–L2678 |
| `api_pool_split` | def | L2682–L2696 |
| `api_pool_publish` | def | L2700–L2734 |
| `unlock_account` | def | L2738–L2756 |
| `_sse_generator` | def | L2759–L2785 |
| `events` | def | L2789–L2799 |
| `account_cards_pipe` | def | L2803–L2829 |
| `account_notes_summary` | def | L2833–L2858 |
| `_record_account_touch` | def | L2861–L2894 |
| `account_details` | def | L2898–L3238 |
| `NoteCreate` | class | L3241–L3242 |
| `create_note` | def | L3246–L3275 |
| `CurpUpdate` | class | L3278–L3279 |
| `update_curp` | def | L3283–L3294 |
| `get_clabes` | def | L3304–L3313 |
| `refresh_clabes` | def | L3317–L3327 |
| `_persist_withdrawal` | def | L3336–L3382 |
| `withdraw` | def | L3386–L3431 |
| `withdraw_status` | def | L3435–L3592 |
| `delete_note` | def | L3596–L3608 |
| `CombosRequest` | class | L3611–L3612 |
| `accounts_combos` | def | L3616–L3629 |
| `accounts_pass_map` | def | L3633–L3638 |
| `list_all_cards` | def | L3642–L3717 |
| `activity_feed` | def | L3721–L3818 |
| `list_deposits` | def | L3822–L3851 |
| `deposits_stats` | def | L3855–L3880 |
| `_persist_auto_mission` | def | L3888–L3918 |
| `admin_maintenance_state` | def | L3922–L3925 |
| `MaintenanceToggleRequest` | class | L3928–L3929 |
| `admin_maintenance_toggle` | def | L3933–L3954 |
