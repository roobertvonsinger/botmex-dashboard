...
| `_event_visible_to` | def | L841–L862 |
| `superadmin_kpis` | def | L866–L1109 |
| `RefreshRequest` | class | L1114–L1115 |
| `accounts_refresh` | def | L1119–L1138 |
| `get_logs` | def | L1144–L1169 |
| `_run_health_checks` | def | L1177–L1213 |
| `health_full` | def | L1217–L1218 |
| `_require_sa` | def | L1226–L1228 |
| `admin_diag` | def | L1232–L1263 |
| `admin_ping` | def | L1267–L1288 |
| `admin_refresh_proxy` | def | L1292–L1299 |
| `admin_services_restart` | def | L1303–L1317 |
| `admin_export_logs` | def | L1321–L1333 |
| `admin_pause_state` | def | L1341–L1343 |
| `admin_pause` | def | L1347–L1359 |
| `admin_resume` | def | L1363–L1369 |
| `admin_emergency_stop` | def | L1373–L1408 |
| `admin_vps_reboot` | def | L1412–L1424 |
| `health_last` | def | L1428–L1429 |
| `health_dismiss` | def | L1433–L1436 |
| `_health_loop` | def | L1439–L1449 |
| `_release_account` | def | L1452–L1472 |
| `_run_lock_janitor` | def | L1475–L1523 |
| `_janitor_loop` | def | L1526–L1536 |
| `_run_window_watcher` | def | L1545–L1617 |
| `_window_watcher_loop` | def | L1620–L1629 |
| `_release_watchdog_tick` | def | L1632–L1731 |
| `_release_watchdog_loop` | def | L1734–L1742 |
| `_start_bg_tasks` | def | L1746–L1750 |
| `LockRequest` | class | L1753–L1755 |
| `lock_account` | def | L1759–L1798 |
| `PublishRequest` | class | L1801–L1803 |
| `publish_accounts` | def | L1807–L1830 |
| `hide_all_accounts` | def | L1834–L1846 |
| `pool_accounts` | def | L1850–L1868 |
| `unlock_account` | def | L1872–L1890 |
| `_sse_generator` | def | L1893–L1920 |
| `events` | def | L1924–L1929 |
| `account_cards_pipe` | def | L1933–L1959 |
| `account_notes_summary` | def | L1963–L1988 |
| `account_details` | def | L1992–L2203 |
| `NoteCreate` | class | L2206–L2207 |
| `create_note` | def | L2211–L2240 |
| `CurpUpdate` | class | L2243–L2244 |
| `update_curp` | def | L2248–L2259 |
| `delete_note` | def | L2263–L2275 |
| `CombosRequest` | class | L2278–L2279 |
| `accounts_combos` | def | L2283–L2296 |
| `accounts_pass_map` | def | L2300–L2305 |
| `list_all_cards` | def | L2309–L2384 |
| `activity_feed` | def | L2388–L2505 |
| `list_deposits` | def | L2509–L2538 |
| `deposits_stats` | def | L2542–L2567 |
