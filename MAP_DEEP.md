...
|---------|------|--------|
| `db` | def | L145–L191 |
| `_migrate` | def | L194–L336 |
| `_backfill_grades_v10_m7` | def | L339–L410 |
| `_resolve_operator` | def | L416–L440 |
| `_is_sa` | def | L443–L445 |
| `_visible_emails` | def | L448–L470 |
| `_broadcast` | def | L477–L495 |
| `_dequeue_blocking` | def | L498–L503 |
| `_no_cache_static_assets` | def | L511–L523 |
| `favicon` | def | L531–L532 |
| `login_page` | def | L536–L539 |
| `_asset_mtimes` | def | L555–L562 |
| `_frontend_version` | def | L565–L569 |
| `index` | def | L573–L597 |
| `api_version` | def | L601–L611 |
| `auth_login` | def | L620–L651 |
| `auth_set_password` | def | L655–L679 |
| `auth_logout` | def | L683–L687 |
| `auth_me` | def | L691–L696 |
| `health` | def | L702–L708 |
| `_build_search_clause` | def | L711–L755 |
| `list_accounts` | def | L759–L875 |
| `list_users` | def | L881–L889 |
| `list_assignments` | def | L893–L914 |
| `AssignRequest` | class | L917–L919 |
| `assign_accounts` | def | L923–L942 |
| `unassign_accounts` | def | L946–L957 |
| `stats` | def | L961–L968 |
| `_wsai_status` | def | L983–L1008 |
| `_maybe_alert_broadcast` | def | L1015–L1032 |
| `_check_one_proxy` | def | L1035–L1061 |
| `_proxy_health` | def | L1064–L1113 |
| `_capmonster_balance` | def | L1116–L1136 |
| `_operator_color` | def | L1141–L1156 |
| `_resolve_who` | def | L1159–L1172 |
| `_event_visible_to` | def | L1175–L1201 |
| `superadmin_kpis` | def | L1205–L1448 |
| `RefreshRequest` | class | L1453–L1454 |
| `accounts_refresh` | def | L1458–L1477 |
| `get_logs` | def | L1483–L1508 |
| `_run_health_checks` | def | L1516–L1552 |
| `health_full` | def | L1556–L1557 |
| `_require_sa` | def | L1565–L1567 |
| `admin_diag` | def | L1571–L1602 |
| `admin_ping` | def | L1606–L1627 |
| `admin_refresh_proxy` | def | L1631–L1638 |
| `admin_services_restart` | def | L1642–L1656 |
| `admin_export_logs` | def | L1660–L1672 |
| `admin_pause_state` | def | L1680–L1682 |
| `admin_pause` | def | L1686–L1698 |
| `admin_resume` | def | L1702–L1708 |
| `admin_emergency_stop` | def | L1712–L1747 |
| `admin_vps_reboot` | def | L1751–L1763 |
| `health_last` | def | L1767–L1768 |
| `health_dismiss` | def | L1772–L1775 |
| `api_marks_list` | def | L1779–L1786 |
| `api_marks_toggle` | def | L1790–L1808 |
| `api_recent` | def | L1812–L1884 |
| `api_accounts_at_hand` | def | L1888–L1996 |
| `_health_loop` | def | L1999–L2009 |
| `_release_account` | def | L2012–L2033 |
| `_run_lock_janitor` | def | L2036–L2084 |
| `_janitor_loop` | def | L2087–L2097 |
| `_run_window_watcher` | def | L2106–L2178 |
| `_window_watcher_loop` | def | L2181–L2190 |
| `_release_watchdog_tick` | def | L2193–L2292 |
| `_release_watchdog_loop` | def | L2295–L2303 |
| `_jwt_keepalive_loop` | def | L2306–L2323 |
| `_account_refresh_loop` | def | L2326–L2344 |
| `_start_bg_tasks` | def | L2348–L2354 |
| `LockRequest` | class | L2357–L2359 |
| `lock_account` | def | L2363–L2402 |
| `PublishRequest` | class | L2405–L2407 |
| `publish_accounts` | def | L2411–L2440 |
| `hide_all_accounts` | def | L2444–L2459 |
| `pool_accounts` | def | L2463–L2481 |
| `api_pool_split` | def | L2485–L2499 |
| `api_pool_publish` | def | L2503–L2537 |
| `unlock_account` | def | L2541–L2559 |
| `_sse_generator` | def | L2562–L2588 |
