...
| `_migrate` | def | L260–L494 |
| `_backfill_grades_v10_m7` | def | L497–L568 |
| `_resolve_operator` | def | L574–L598 |
| `_is_sa` | def | L601–L603 |
| `_visible_emails` | def | L606–L628 |
| `_broadcast` | def | L635–L653 |
| `_dequeue_blocking` | def | L656–L661 |
| `_is_maintenance_active` | def | L670–L673 |
| `_maintenance_gate_middleware` | def | L676–L704 |
| `_no_cache_static_assets` | def | L708–L720 |
| `favicon` | def | L735–L736 |
| `maintenance_page` | def | L740–L741 |
| `login_page` | def | L745–L749 |
| `_asset_mtimes` | def | L766–L773 |
| `_frontend_version` | def | L776–L780 |
| `_own_portal_path` | def | L783–L784 |
| `_render_frontend_html` | def | L787–L811 |
| `user_portal_page` | def | L815–L830 |
| `portal_page` | def | L834–L841 |
| `dashboard_page` | def | L845–L859 |
| `index` | def | L863–L872 |
| `username_portal_page` | def | L876–L902 |
| `api_version` | def | L906–L916 |
| `auth_login` | def | L925–L956 |
| `auth_set_password` | def | L960–L984 |
| `auth_logout` | def | L988–L992 |
| `auth_me` | def | L996–L1006 |
| `health` | def | L1012–L1018 |
| `_build_search_clause` | def | L1021–L1065 |
| `list_accounts` | def | L1069–L1199 |
| `list_users` | def | L1205–L1213 |
| `list_assignments` | def | L1217–L1238 |
| `AssignRequest` | class | L1241–L1243 |
| `assign_accounts` | def | L1247–L1266 |
| `unassign_accounts` | def | L1270–L1281 |
| `stats` | def | L1285–L1292 |
| `_wsai_status` | def | L1307–L1332 |
| `_maybe_alert_broadcast` | def | L1339–L1356 |
| `_check_one_proxy` | def | L1359–L1385 |
| `_proxy_health` | def | L1388–L1437 |
| `_capmonster_balance` | def | L1440–L1460 |
| `_operator_color` | def | L1465–L1480 |
| `_resolve_who` | def | L1483–L1496 |
| `_event_visible_to` | def | L1499–L1525 |
| `superadmin_kpis` | def | L1529–L1772 |
| `RefreshRequest` | class | L1777–L1778 |
| `accounts_refresh` | def | L1782–L1801 |
| `_tail_log_file` | def | L1828–L1856 |
| `get_logs` | def | L1860–L1882 |
| `get_logs_telegram` | def | L1892–L1907 |
| `_run_health_checks` | def | L1915–L1951 |
| `health_full` | def | L1955–L1956 |
| `_require_sa` | def | L1964–L1966 |
| `admin_diag` | def | L1970–L2001 |
| `admin_ping` | def | L2005–L2026 |
| `admin_refresh_proxy` | def | L2030–L2037 |
| `admin_services_restart` | def | L2041–L2062 |
| `admin_export_logs` | def | L2066–L2082 |
| `admin_pause_state` | def | L2090–L2092 |
| `admin_pause` | def | L2096–L2108 |
| `admin_resume` | def | L2112–L2118 |
| `admin_emergency_stop` | def | L2122–L2157 |
| `admin_vps_reboot` | def | L2161–L2173 |
| `health_last` | def | L2177–L2178 |
| `health_dismiss` | def | L2182–L2185 |
| `api_marks_list` | def | L2189–L2196 |
| `api_marks_toggle` | def | L2200–L2218 |
| `api_recent` | def | L2222–L2294 |
| `api_accounts_at_hand` | def | L2298–L2406 |
| `_health_loop` | def | L2409–L2419 |
| `_release_account` | def | L2422–L2443 |
| `_run_lock_janitor` | def | L2446–L2494 |
| `_janitor_loop` | def | L2497–L2507 |
| `_run_window_watcher` | def | L2516–L2588 |
| `_window_watcher_loop` | def | L2591–L2600 |
| `_release_watchdog_tick` | def | L2603–L2702 |
| `_release_watchdog_loop` | def | L2705–L2713 |
| `_jwt_keepalive_loop` | def | L2716–L2744 |
| `_wake_jwt_keeper` | def | L2751–L2762 |
| `_account_refresh_loop` | def | L2765–L2783 |
| `_bot_token` | def | L2789–L2798 |
| `_notify_robert` | def | L2801–L2816 |
| `_startup_telegram_notify` | def | L2819–L2843 |
| `_lifespan` | def | L2847–L2858 |
| `LockRequest` | class | L2864–L2866 |
| `lock_account` | def | L2870–L2909 |
| `PublishRequest` | class | L2912–L2914 |
| `publish_accounts` | def | L2918–L2947 |
| `hide_all_accounts` | def | L2951–L2966 |
| `pool_accounts` | def | L2970–L2988 |
| `api_pool_split` | def | L2992–L3006 |
| `api_pool_publish` | def | L3010–L3044 |
| `unlock_account` | def | L3048–L3066 |
| `_sse_generator` | def | L3069–L3095 |
| `events` | def | L3099–L3109 |
| `account_cards_pipe` | def | L3113–L3139 |
| `account_notes_summary` | def | L3143–L3168 |
| `_record_account_touch` | def | L3171–L3204 |
| `account_find_id` | def | L3208–L3214 |
| `account_details` | def | L3218–L3598 |
| `NoteCreate` | class | L3601–L3602 |
| `create_note` | def | L3606–L3635 |
| `CurpUpdate` | class | L3638–L3639 |
| `update_curp` | def | L3643–L3654 |
| `get_clabes` | def | L3664–L3673 |
| `refresh_clabes` | def | L3677–L3687 |
| `_persist_withdrawal` | def | L3696–L3742 |
| `withdraw` | def | L3746–L3798 |
| `withdraw_status` | def | L3802–L3853 |
| `delete_note` | def | L3857–L3869 |
| `CombosRequest` | class | L3872–L3873 |
| `accounts_combos` | def | L3877–L3890 |
| `accounts_pass_map` | def | L3894–L3899 |
| `list_all_cards` | def | L3903–L3979 |
| `activity_feed` | def | L3983–L4080 |
| `list_deposits` | def | L4084–L4113 |
| `deposits_stats` | def | L4117–L4142 |
| `_persist_auto_mission` | def | L4150–L4180 |
| `admin_maintenance_state` | def | L4184–L4187 |
| `MaintenanceToggleRequest` | class | L4190–L4191 |
| `admin_maintenance_toggle` | def | L4195–L4216 |
| `auto_deposit_create` | def | L4220–L4256 |
| `auto_deposit_cancel` | def | L4260–L4286 |
| `operator_my_accounts` | def | L4290–L4380 |
| `operator_release_account` | def | L4384–L4401 |
| `operator_withdraw` | def | L4405–L4463 |
| `operator_missions` | def | L4467–L4485 |
| `auto_deposit_status` | def | L4489–L4500 |
| `register_operator_strike` | def | L4503–L4536 |
| `bot_start_info` | def | L4540–L4576 |
| `bot_operator_info` | def | L4580–L4619 |
| `bot_help_info` | def | L4623–L4637 |
| `bot_pause_mission` | def | L4641–L4670 |
| `bot_resume_mission` | def | L4674–L4692 |
| `bot_cancel_mission` | def | L4697–L4732 |
| `bot_bet_create` | def | L4736–L4905 |
| `filter_and_sanitize_check_combos` | def | L4908–L4993 |
| `BotCheckRequest` | class | L4996–L5000 |
| `bot_check` | def | L5003–L5084 |
...
| `plan_auto_mission` | def | L357–L594 |
| `_fake_progress_pct` | def | L635–L666 |
| `_iso` | def | L670–L671 |
| `_m_load` | def | L674–L682 |
| `_m_status` | def | L685–L687 |
| `_m_update` | def | L690–L700 |
| `_fetch_account` | def | L703–L710 |
...
| `_auto_lock_for_deposit` | def | L391–L446 |
| `_window_status` | def | L449–L491 |
| `_check_caps` | def | L494–L510 |
| `_load_deps` | def | L513–L524 |
| `_parse_pipe` | def | L527–L548 |
| `_check_card_velocity` | def | L568–L615 |
| `_has_recent_approved_deposit` | def | L618–L634 |
| `_record_attempt` | def | L637–L819 |
| `_safe_phase` | def | L829–L836 |
| `_now_mx_str` | def | L844–L853 |
| `_deposit_step_payload` | def | L862–L870 |
| `_wrap_deposit_step` | def | L873–L892 |
| `_build_admin_proxy_url` | def | L895–L899 |
| `_refresh_account_after_deposit` | def | L902–L961 |
| `_should_relogin_after_401` | def | L964–L968 |
| `_acquire_session_and_begin` | def | L971–L1224 |
| `_run_deposit_with_phases` | def | L1227–L1571 |
| `deposit_execute_stream` | def | L1575–L1774 |
| `cap_status` | def | L1778–L1790 |
| `_mm_is_real_decline` | def | L1827–L1833 |
| `_mm_is_ambiguous_charge` | def | L1836–L1846 |
| `classify_deposit_status` | def | L1849–L1880 |
| `_mm_session_get` | def | L1926–L1930 |
| `_mm_session_update` | def | L1933–L1942 |
| `multi_stream` | def | L1946–L2460 |
| `multi_cancel` | def | L2464–L2469 |
| `scheduled_create` | def | L2482–L2846 |
| `scheduled_list` | def | L2850–L2872 |
| `scheduled_cancel` | def | L2876–L2884 |
