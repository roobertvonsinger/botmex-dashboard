...
| `_migrate` | def | L190–L475 |
| `_backfill_grades_v10_m7` | def | L478–L549 |
| `_resolve_operator` | def | L555–L579 |
| `_is_sa` | def | L582–L584 |
| `_visible_emails` | def | L587–L609 |
| `_broadcast` | def | L616–L634 |
| `_dequeue_blocking` | def | L637–L642 |
| `_configure_asyncio_exception_handler` | def | L649–L699 |
| `_is_maintenance_active` | def | L710–L715 |
| `_maintenance_gate_middleware` | def | L718–L746 |
| `_no_cache_static_assets` | def | L750–L762 |
| `favicon` | def | L777–L778 |
| `maintenance_page` | def | L782–L783 |
| `login_page` | def | L787–L791 |
| `_asset_mtimes` | def | L808–L815 |
| `_frontend_version` | def | L818–L822 |
| `_own_portal_path` | def | L825–L826 |
| `_render_frontend_html` | def | L829–L853 |
| `user_portal_page` | def | L857–L872 |
| `portal_page` | def | L876–L883 |
| `dashboard_page` | def | L887–L901 |
| `index` | def | L905–L914 |
| `username_portal_page` | def | L918–L944 |
| `api_version` | def | L948–L958 |
| `auth_login` | def | L967–L998 |
| `auth_set_password` | def | L1002–L1026 |
| `auth_logout` | def | L1030–L1034 |
| `auth_me` | def | L1038–L1048 |
| `health_ping` | def | L1054–L1061 |
| `health` | def | L1067–L1075 |
| `_build_search_clause` | def | L1078–L1122 |
| `list_accounts` | def | L1126–L1272 |
| `list_users` | def | L1278–L1286 |
| `list_assignments` | def | L1290–L1311 |
| `AssignRequest` | class | L1314–L1316 |
| `assign_accounts` | def | L1320–L1339 |
| `unassign_accounts` | def | L1343–L1354 |
| `stats` | def | L1358–L1365 |
| `_wsai_status` | def | L1380–L1405 |
| `_maybe_alert_broadcast` | def | L1412–L1429 |
| `_check_one_proxy` | def | L1432–L1458 |
| `_proxy_health` | def | L1461–L1510 |
| `_capmonster_balance` | def | L1513–L1533 |
| `_operator_color` | def | L1538–L1553 |
| `_resolve_who` | def | L1556–L1569 |
| `_event_visible_to` | def | L1572–L1598 |
| `superadmin_kpis` | def | L1602–L1845 |
| `RefreshRequest` | class | L1850–L1851 |
| `accounts_refresh` | def | L1855–L1874 |
| `_tail_log_file` | def | L1904–L1942 |
| `_get_cached_logs` | def | L1949–L1961 |
| `get_logs` | def | L1975–L2002 |
| `get_logs_telegram` | def | L2006–L2056 |
| `_run_health_checks` | def | L2064–L2100 |
| `health_full` | def | L2104–L2105 |
| `_require_sa` | def | L2113–L2115 |
| `admin_diag` | def | L2119–L2150 |
| `admin_ping` | def | L2154–L2175 |
| `admin_refresh_proxy` | def | L2179–L2186 |
| `admin_services_restart` | def | L2190–L2211 |
| `admin_export_logs` | def | L2215–L2231 |
| `admin_pause_state` | def | L2239–L2241 |
| `admin_pause` | def | L2245–L2257 |
| `admin_resume` | def | L2261–L2267 |
| `admin_emergency_stop` | def | L2271–L2306 |
| `admin_vps_reboot` | def | L2310–L2322 |
| `health_last` | def | L2326–L2327 |
| `health_dismiss` | def | L2331–L2334 |
| `api_marks_list` | def | L2338–L2345 |
| `api_marks_toggle` | def | L2349–L2367 |
| `api_recent` | def | L2371–L2443 |
| `api_accounts_at_hand` | def | L2447–L2555 |
| `_health_loop` | def | L2558–L2568 |
| `_release_account` | def | L2571–L2592 |
| `_run_lock_janitor` | def | L2595–L2643 |
| `_janitor_loop` | def | L2646–L2656 |
| `_run_window_watcher` | def | L2665–L2737 |
| `_window_watcher_loop` | def | L2740–L2749 |
| `_release_watchdog_tick` | def | L2752–L2851 |
| `_release_watchdog_loop` | def | L2854–L2862 |
| `_jwt_keepalive_loop` | def | L2865–L2893 |
| `_wake_jwt_keeper` | def | L2900–L2911 |
| `_account_refresh_loop` | def | L2914–L2932 |
| `_bot_token` | def | L2938–L2947 |
| `_notify_robert` | def | L2950–L2965 |
| `_startup_telegram_notify` | def | L2968–L2992 |
| `_lifespan` | def | L2996–L3008 |
| `LockRequest` | class | L3014–L3016 |
| `lock_account` | def | L3020–L3059 |
| `PublishRequest` | class | L3062–L3064 |
| `publish_accounts` | def | L3068–L3097 |
| `hide_all_accounts` | def | L3101–L3116 |
| `pool_accounts` | def | L3120–L3138 |
| `api_pool_split` | def | L3142–L3156 |
| `api_pool_publish` | def | L3160–L3187 |
| `unlock_account` | def | L3191–L3209 |
| `_sse_generator` | def | L3212–L3241 |
| `events` | def | L3245–L3255 |
| `account_cards_pipe` | def | L3259–L3285 |
| `account_notes_summary` | def | L3289–L3314 |
| `_record_account_touch` | def | L3317–L3350 |
| `account_find_id` | def | L3354–L3360 |
| `account_refresh_api` | def | L3364–L3469 |
| `account_details` | def | L3473–L3864 |
| `NoteCreate` | class | L3867–L3868 |
| `create_note` | def | L3872–L3901 |
| `CurpUpdate` | class | L3904–L3905 |
| `update_curp` | def | L3909–L3920 |
| `get_clabes` | def | L3930–L3939 |
| `refresh_clabes` | def | L3943–L3953 |
| `_persist_withdrawal` | def | L3962–L4008 |
| `withdraw` | def | L4012–L4064 |
| `withdraw_status` | def | L4068–L4131 |
| `delete_note` | def | L4135–L4147 |
| `CombosRequest` | class | L4150–L4151 |
| `accounts_combos` | def | L4155–L4168 |
| `accounts_pass_map` | def | L4172–L4177 |
| `list_all_cards` | def | L4181–L4257 |
| `activity_feed` | def | L4261–L4358 |
| `list_deposits` | def | L4362–L4391 |
| `deposits_stats` | def | L4395–L4420 |
| `_persist_auto_mission` | def | L4428–L4459 |
| `admin_maintenance_state` | def | L4463–L4466 |
| `MaintenanceToggleRequest` | class | L4469–L4470 |
| `admin_maintenance_toggle` | def | L4474–L4497 |
| `auto_deposit_create` | def | L4501–L4537 |
| `auto_deposit_cancel` | def | L4541–L4567 |
| `emergency_stop_all_deposits` | def | L4571–L4602 |
| `operator_my_accounts` | def | L4606–L4696 |
| `operator_release_account` | def | L4700–L4717 |
| `operator_withdraw` | def | L4721–L4779 |
| `operator_auto_withdraw` | def | L4783–L4819 |
| `auto_deposit_confirm` | def | L4823–L4842 |
| `operator_missions` | def | L4846–L4864 |
| `operator_recent_ticker` | def | L4868–L4993 |
| `auto_deposit_status` | def | L4997–L5008 |
| `register_operator_strike` | def | L5011–L5044 |
| `bot_start_info` | def | L5048–L5084 |
| `bot_operator_info` | def | L5088–L5127 |
| `bot_help_info` | def | L5131–L5145 |
| `bot_pause_mission` | def | L5149–L5178 |
| `bot_resume_mission` | def | L5182–L5200 |
| `bot_cancel_mission` | def | L5205–L5240 |
| `bot_bet_create` | def | L5244–L5414 |
| `filter_and_sanitize_check_combos` | def | L5417–L5502 |
| `BotCheckRequest` | class | L5505–L5509 |
| `bot_check` | def | L5512–L5593 |
