...
| `_migrate` | def | L190–L503 |
| `_backfill_grades_v10_m7` | def | L506–L577 |
| `_resolve_operator` | def | L583–L607 |
| `_is_sa` | def | L610–L612 |
| `_visible_emails` | def | L615–L637 |
| `_broadcast` | def | L644–L662 |
| `_dequeue_blocking` | def | L665–L670 |
| `_configure_asyncio_exception_handler` | def | L677–L727 |
| `_is_maintenance_active` | def | L738–L743 |
| `_maintenance_gate_middleware` | def | L746–L774 |
| `_no_cache_static_assets` | def | L778–L790 |
| `favicon` | def | L805–L806 |
| `maintenance_page` | def | L810–L811 |
| `login_page` | def | L815–L819 |
| `_asset_mtimes` | def | L836–L843 |
| `_frontend_version` | def | L846–L850 |
| `_own_portal_path` | def | L853–L854 |
| `_render_frontend_html` | def | L857–L881 |
| `user_portal_page` | def | L885–L900 |
| `portal_page` | def | L904–L911 |
| `dashboard_page` | def | L915–L929 |
| `index` | def | L933–L942 |
| `username_portal_page` | def | L946–L972 |
| `api_version` | def | L976–L986 |
| `auth_login` | def | L995–L1026 |
| `auth_set_password` | def | L1030–L1054 |
| `auth_logout` | def | L1058–L1062 |
| `auth_me` | def | L1066–L1076 |
| `health_ping` | def | L1082–L1089 |
| `health` | def | L1095–L1103 |
| `_build_search_clause` | def | L1106–L1150 |
| `list_accounts` | def | L1154–L1300 |
| `api_list_playdoit_accounts` | def | L1306–L1320 |
| `api_get_playdoit_stats` | def | L1324–L1332 |
| `list_users` | def | L1338–L1346 |
| `list_assignments` | def | L1350–L1371 |
| `AssignRequest` | class | L1374–L1376 |
| `assign_accounts` | def | L1380–L1399 |
| `unassign_accounts` | def | L1403–L1414 |
| `stats` | def | L1418–L1425 |
| `_wsai_status` | def | L1440–L1465 |
| `_maybe_alert_broadcast` | def | L1472–L1489 |
| `_check_one_proxy` | def | L1492–L1518 |
| `_proxy_health` | def | L1521–L1570 |
| `_capmonster_balance` | def | L1573–L1593 |
| `_operator_color` | def | L1598–L1613 |
| `_resolve_who` | def | L1616–L1629 |
| `_event_visible_to` | def | L1632–L1658 |
| `superadmin_kpis` | def | L1662–L1905 |
| `RefreshRequest` | class | L1910–L1911 |
| `accounts_refresh` | def | L1915–L1934 |
| `_tail_log_file` | def | L1964–L2002 |
| `_get_cached_logs` | def | L2009–L2021 |
| `get_logs` | def | L2035–L2062 |
| `get_logs_telegram` | def | L2066–L2131 |
| `_run_health_checks` | def | L2139–L2175 |
| `health_full` | def | L2179–L2180 |
| `_require_sa` | def | L2188–L2190 |
| `admin_diag` | def | L2194–L2225 |
| `admin_ping` | def | L2229–L2250 |
| `admin_refresh_proxy` | def | L2254–L2261 |
| `admin_services_restart` | def | L2265–L2286 |
| `admin_export_logs` | def | L2290–L2306 |
| `admin_pause_state` | def | L2314–L2316 |
| `admin_pause` | def | L2320–L2332 |
| `admin_resume` | def | L2336–L2342 |
| `admin_emergency_stop` | def | L2346–L2381 |
| `admin_vps_reboot` | def | L2385–L2397 |
| `health_last` | def | L2401–L2402 |
| `health_dismiss` | def | L2406–L2409 |
| `api_marks_list` | def | L2413–L2420 |
| `api_marks_toggle` | def | L2424–L2442 |
| `api_recent` | def | L2446–L2518 |
| `api_accounts_at_hand` | def | L2522–L2630 |
| `_health_loop` | def | L2633–L2643 |
| `_release_account` | def | L2646–L2667 |
| `_run_lock_janitor` | def | L2670–L2718 |
| `_janitor_loop` | def | L2721–L2731 |
| `_run_window_watcher` | def | L2740–L2812 |
| `_window_watcher_loop` | def | L2815–L2824 |
| `_release_watchdog_tick` | def | L2827–L2926 |
| `_release_watchdog_loop` | def | L2929–L2937 |
| `_jwt_keepalive_loop` | def | L2940–L2968 |
| `_wake_jwt_keeper` | def | L2975–L2986 |
| `_account_refresh_loop` | def | L2989–L3007 |
| `_bot_token` | def | L3013–L3022 |
| `_notify_robert` | def | L3025–L3040 |
| `_startup_telegram_notify` | def | L3043–L3067 |
| `_lifespan` | def | L3071–L3083 |
| `LockRequest` | class | L3089–L3091 |
| `lock_account` | def | L3095–L3134 |
| `PublishRequest` | class | L3137–L3139 |
| `publish_accounts` | def | L3143–L3172 |
| `hide_all_accounts` | def | L3176–L3191 |
| `pool_accounts` | def | L3195–L3213 |
| `api_pool_split` | def | L3217–L3231 |
| `api_pool_publish` | def | L3235–L3262 |
| `unlock_account` | def | L3266–L3284 |
| `_sse_generator` | def | L3287–L3316 |
| `events` | def | L3320–L3330 |
| `account_cards_pipe` | def | L3334–L3360 |
| `account_notes_summary` | def | L3364–L3389 |
| `_record_account_touch` | def | L3392–L3425 |
| `account_find_id` | def | L3429–L3435 |
| `account_refresh_api` | def | L3439–L3544 |
| `account_details` | def | L3548–L3939 |
| `NoteCreate` | class | L3942–L3943 |
| `create_note` | def | L3947–L3976 |
| `CurpUpdate` | class | L3979–L3980 |
| `update_curp` | def | L3984–L3995 |
| `get_clabes` | def | L4005–L4014 |
| `refresh_clabes` | def | L4018–L4028 |
| `_persist_withdrawal` | def | L4037–L4083 |
| `withdraw` | def | L4087–L4139 |
| `withdraw_status` | def | L4143–L4206 |
| `delete_note` | def | L4210–L4222 |
| `CombosRequest` | class | L4225–L4226 |
| `accounts_combos` | def | L4230–L4243 |
| `accounts_pass_map` | def | L4247–L4252 |
| `list_all_cards` | def | L4256–L4332 |
| `activity_feed` | def | L4336–L4433 |
| `list_deposits` | def | L4437–L4466 |
| `deposits_stats` | def | L4470–L4495 |
| `_persist_auto_mission` | def | L4503–L4534 |
| `admin_maintenance_state` | def | L4538–L4541 |
| `MaintenanceToggleRequest` | class | L4544–L4545 |
| `admin_maintenance_toggle` | def | L4549–L4572 |
| `auto_deposit_create` | def | L4576–L4628 |
| `auto_deposit_cancel` | def | L4632–L4658 |
| `emergency_stop_all_deposits` | def | L4662–L4693 |
| `operator_my_accounts` | def | L4697–L4787 |
| `operator_release_account` | def | L4791–L4808 |
| `operator_withdraw` | def | L4812–L4870 |
| `operator_auto_withdraw` | def | L4874–L4910 |
| `auto_deposit_confirm` | def | L4914–L4933 |
| `operator_missions` | def | L4937–L4955 |
| `operator_recent_ticker` | def | L4959–L5084 |
| `auto_deposit_status` | def | L5088–L5099 |
| `register_operator_strike` | def | L5102–L5135 |
| `bot_start_info` | def | L5139–L5175 |
| `bot_operator_info` | def | L5179–L5218 |
| `bot_help_info` | def | L5222–L5236 |
| `bot_pause_mission` | def | L5240–L5269 |
| `bot_resume_mission` | def | L5273–L5291 |
| `bot_cancel_mission` | def | L5296–L5331 |
| `bot_bet_create` | def | L5335–L5520 |
| `filter_and_sanitize_check_combos` | def | L5523–L5608 |
| `BotCheckRequest` | class | L5611–L5615 |
| `bot_check` | def | L5618–L5699 |
...
| Símbolo | Tipo | Líneas |
|---------|------|--------|
| `_now_epoch` | def | L31–L32 |
| `_grade_rank` | def | L35–L38 |
| `_sa_tokens` | def | L41–L52 |
| `_cd_active` | def | L55–L71 |
| `_exp_int` | def | L74–L80 |
| `_bin_of` | def | L83–L85 |
| `_approval_rate` | def | L88–L94 |
| `_threeds_recent` | def | L97–L111 |
| `_rank_key` | def | L114–L117 |
| `_pipe_str` | def | L120–L125 |
| `_extract_card_number` | def | L128–L135 |
| `_parse_card_pipe` | def | L138–L171 |
...
| `plan_not_worse` | def | L420–L440 |
| `_cost_usd` | def | L443–L445 |
| `_record_llm_call` | def | L448–L471 |

### `bet_policy.py`

| Símbolo | Tipo | Líneas |
|---------|------|--------|
| `BetPolicyConfig` | class | L36–L63 |
| `_policy_path` | def | L101–L102 |
| `_field_names` | def | L105–L106 |
| `digest` | def | L109–L115 |
| `_coerce_in_bounds` | def | L118–L125 |
| `_sanitize_overrides` | def | L128–L143 |
| `load_policy` | def | L146–L165 |
| `apply` | def | L168–L212 |
...
| Símbolo | Tipo | Líneas |
|---------|------|--------|
| `_load_ruthopia_dashboard_token` | def | L29–L67 |
| `ruthopia_bridge_check` | def | L70–L107 |
| `check_luhn` | def | L110–L123 |
| `parse_and_validate_card_pipe` | def | L126–L175 |
| `check_ruthopia_db_liveness` | def | L183–L241 |
...
| `_run_deposit_with_phases` | def | L1517–L1874 |
| `deposit_execute_stream` | def | L1878–L2095 |
| `cap_status` | def | L2099–L2111 |
| `_mm_is_real_decline` | def | L2151–L2157 |
| `_mm_is_ambiguous_charge` | def | L2160–L2170 |
| `classify_deposit_status` | def | L2173–L2204 |
| `_mm_session_get` | def | L2247–L2269 |
| `_mm_session_update` | def | L2272–L2281 |
| `multi_stream` | def | L2285–L2840 |
| `multi_cancel` | def | L2844–L2849 |
| `scheduled_create` | def | L2862–L3235 |
| `scheduled_list` | def | L3239–L3261 |
| `scheduled_cancel` | def | L3265–L3273 |
...
| `GET` | `/api/playdoit/accounts` | `app.py` |
| `GET` | `/api/playdoit/stats` | `app.py` |
...
| `betmexico.dashboard.bet_advisor` | `bet_advisor.py` |
...
| `playdoit_api` | `playdoit_api.py` |
| `playdoit_db` | `playdoit_db.py` |
