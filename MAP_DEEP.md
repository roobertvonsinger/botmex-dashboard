...
| `_check_one_proxy` | def | L625–L650 |
| `_proxy_health` | def | L653–L698 |
| `_capmonster_balance` | def | L701–L721 |
| `_operator_color` | def | L726–L727 |
| `_resolve_who` | def | L730–L738 |
| `superadmin_kpis` | def | L742–L985 |
| `RefreshRequest` | class | L990–L991 |
| `accounts_refresh` | def | L995–L1014 |
| `get_logs` | def | L1020–L1045 |
| `_run_health_checks` | def | L1053–L1089 |
| `health_full` | def | L1093–L1094 |
| `_require_sa` | def | L1102–L1104 |
| `admin_diag` | def | L1108–L1139 |
| `admin_ping` | def | L1143–L1164 |
| `admin_refresh_proxy` | def | L1168–L1175 |
| `admin_services_restart` | def | L1179–L1193 |
| `admin_export_logs` | def | L1197–L1209 |
| `admin_pause_state` | def | L1217–L1219 |
| `admin_pause` | def | L1223–L1235 |
| `admin_resume` | def | L1239–L1245 |
| `admin_emergency_stop` | def | L1249–L1284 |
| `admin_vps_reboot` | def | L1288–L1300 |
| `health_last` | def | L1304–L1305 |
| `health_dismiss` | def | L1309–L1312 |
| `_health_loop` | def | L1315–L1325 |
| `_run_lock_janitor` | def | L1328–L1386 |
| `_janitor_loop` | def | L1389–L1399 |
| `_run_window_watcher` | def | L1408–L1482 |
| `_window_watcher_loop` | def | L1485–L1494 |
| `_release_watchdog_tick` | def | L1497–L1613 |
| `_release_watchdog_loop` | def | L1616–L1624 |
| `_start_bg_tasks` | def | L1628–L1632 |
| `LockRequest` | class | L1635–L1637 |
| `lock_account` | def | L1641–L1669 |
| `PublishRequest` | class | L1672–L1674 |
| `publish_accounts` | def | L1678–L1693 |
| `hide_all_accounts` | def | L1697–L1708 |
| `pool_accounts` | def | L1712–L1730 |
| `unlock_account` | def | L1734–L1761 |
| `_sse_generator` | def | L1764–L1791 |
| `events` | def | L1795–L1800 |
| `account_cards_pipe` | def | L1804–L1829 |
| `account_notes_summary` | def | L1833–L1858 |
| `account_details` | def | L1862–L2066 |
| `NoteCreate` | class | L2069–L2070 |
| `create_note` | def | L2074–L2103 |
| `CurpUpdate` | class | L2106–L2107 |
| `update_curp` | def | L2111–L2122 |
| `delete_note` | def | L2126–L2138 |
| `CombosRequest` | class | L2141–L2142 |
| `accounts_combos` | def | L2146–L2155 |
| `accounts_pass_map` | def | L2159–L2163 |
| `list_all_cards` | def | L2167–L2237 |
| `activity_feed` | def | L2241–L2358 |
| `list_deposits` | def | L2362–L2387 |
| `deposits_stats` | def | L2391–L2416 |
...
| `_run_deposit_with_phases` | def | L615–L1069 |
| `deposit_execute` | def | L1073–L1210 |
| `deposit_execute_stream` | def | L1214–L1422 |
| `cap_status` | def | L1426–L1438 |
| `multi_stream` | def | L1470–L1840 |
| `multi_cancel` | def | L1844–L1849 |
| `scheduled_create` | def | L1862–L2151 |
| `scheduled_list` | def | L2155–L2177 |
| `scheduled_cancel` | def | L2181–L2189 |
