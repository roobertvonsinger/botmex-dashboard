...
| `_maintenance_gate_middleware` | def | L618–L643 |
| `_no_cache_static_assets` | def | L647–L659 |
| `favicon` | def | L667–L668 |
| `maintenance_page` | def | L672–L673 |
| `login_page` | def | L677–L680 |
| `_asset_mtimes` | def | L696–L703 |
| `_frontend_version` | def | L706–L710 |
| `index` | def | L714–L738 |
| `api_version` | def | L742–L752 |
| `auth_login` | def | L761–L792 |
| `auth_set_password` | def | L796–L820 |
| `auth_logout` | def | L824–L828 |
| `auth_me` | def | L832–L837 |
| `health` | def | L843–L849 |
| `_build_search_clause` | def | L852–L896 |
| `list_accounts` | def | L900–L1022 |
| `list_users` | def | L1028–L1036 |
| `list_assignments` | def | L1040–L1061 |
| `AssignRequest` | class | L1064–L1066 |
| `assign_accounts` | def | L1070–L1089 |
| `unassign_accounts` | def | L1093–L1104 |
| `stats` | def | L1108–L1115 |
| `_wsai_status` | def | L1130–L1155 |
| `_maybe_alert_broadcast` | def | L1162–L1179 |
| `_check_one_proxy` | def | L1182–L1208 |
| `_proxy_health` | def | L1211–L1260 |
| `_capmonster_balance` | def | L1263–L1283 |
| `_operator_color` | def | L1288–L1303 |
| `_resolve_who` | def | L1306–L1319 |
| `_event_visible_to` | def | L1322–L1348 |
| `superadmin_kpis` | def | L1352–L1595 |
| `RefreshRequest` | class | L1600–L1601 |
| `accounts_refresh` | def | L1605–L1624 |
| `_tail_log_file` | def | L1644–L1672 |
| `get_logs` | def | L1676–L1686 |
| `get_logs_telegram` | def | L1696–L1711 |
| `_run_health_checks` | def | L1719–L1755 |
| `health_full` | def | L1759–L1760 |
| `_require_sa` | def | L1768–L1770 |
| `admin_diag` | def | L1774–L1805 |
| `admin_ping` | def | L1809–L1830 |
| `admin_refresh_proxy` | def | L1834–L1841 |
| `admin_services_restart` | def | L1845–L1859 |
| `admin_export_logs` | def | L1863–L1875 |
| `admin_pause_state` | def | L1883–L1885 |
| `admin_pause` | def | L1889–L1901 |
| `admin_resume` | def | L1905–L1911 |
| `admin_emergency_stop` | def | L1915–L1950 |
| `admin_vps_reboot` | def | L1954–L1966 |
| `health_last` | def | L1970–L1971 |
| `health_dismiss` | def | L1975–L1978 |
| `api_marks_list` | def | L1982–L1989 |
| `api_marks_toggle` | def | L1993–L2011 |
| `api_recent` | def | L2015–L2087 |
| `api_accounts_at_hand` | def | L2091–L2199 |
| `_health_loop` | def | L2202–L2212 |
| `_release_account` | def | L2215–L2236 |
| `_run_lock_janitor` | def | L2239–L2287 |
| `_janitor_loop` | def | L2290–L2300 |
| `_run_window_watcher` | def | L2309–L2381 |
| `_window_watcher_loop` | def | L2384–L2393 |
| `_release_watchdog_tick` | def | L2396–L2495 |
| `_release_watchdog_loop` | def | L2498–L2506 |
| `_jwt_keepalive_loop` | def | L2509–L2526 |
| `_account_refresh_loop` | def | L2529–L2547 |
| `_startup_telegram_notify` | def | L2550–L2572 |
| `_start_bg_tasks` | def | L2576–L2583 |
| `LockRequest` | class | L2586–L2588 |
| `lock_account` | def | L2592–L2631 |
| `PublishRequest` | class | L2634–L2636 |
| `publish_accounts` | def | L2640–L2669 |
| `hide_all_accounts` | def | L2673–L2688 |
| `pool_accounts` | def | L2692–L2710 |
| `api_pool_split` | def | L2714–L2728 |
| `api_pool_publish` | def | L2732–L2766 |
| `unlock_account` | def | L2770–L2788 |
| `_sse_generator` | def | L2791–L2817 |
| `events` | def | L2821–L2831 |
| `account_cards_pipe` | def | L2835–L2861 |
| `account_notes_summary` | def | L2865–L2890 |
| `_record_account_touch` | def | L2893–L2926 |
| `account_find_id` | def | L2930–L2936 |
| `account_details` | def | L2940–L3280 |
| `NoteCreate` | class | L3283–L3284 |
| `create_note` | def | L3288–L3317 |
| `CurpUpdate` | class | L3320–L3321 |
| `update_curp` | def | L3325–L3336 |
| `get_clabes` | def | L3346–L3355 |
| `refresh_clabes` | def | L3359–L3369 |
| `_persist_withdrawal` | def | L3378–L3424 |
| `withdraw` | def | L3428–L3473 |
| `withdraw_status` | def | L3477–L3634 |
| `delete_note` | def | L3638–L3650 |
| `CombosRequest` | class | L3653–L3654 |
| `accounts_combos` | def | L3658–L3671 |
| `accounts_pass_map` | def | L3675–L3680 |
| `list_all_cards` | def | L3684–L3759 |
| `activity_feed` | def | L3763–L3860 |
| `list_deposits` | def | L3864–L3893 |
| `deposits_stats` | def | L3897–L3922 |
| `_persist_auto_mission` | def | L3930–L3960 |
| `admin_maintenance_state` | def | L3964–L3967 |
| `MaintenanceToggleRequest` | class | L3970–L3971 |
| `admin_maintenance_toggle` | def | L3975–L3996 |
| `auto_deposit_create` | def | L4000–L4036 |
| `auto_deposit_cancel` | def | L4040–L4066 |
| `auto_deposit_status` | def | L4070–L4081 |
| `register_operator_strike` | def | L4084–L4117 |
| `bot_start_info` | def | L4121–L4157 |
| `bot_operator_info` | def | L4161–L4200 |
| `bot_help_info` | def | L4204–L4218 |
| `bot_pause_mission` | def | L4222–L4251 |
| `bot_resume_mission` | def | L4255–L4273 |
| `bot_cancel_mission` | def | L4278–L4313 |
| `bot_bet_create` | def | L4317–L4486 |
| `filter_and_sanitize_check_combos` | def | L4489–L4574 |
| `BotCheckRequest` | class | L4577–L4581 |
| `bot_check` | def | L4584–L4665 |
...
| `_broadcast_mission` | def | L628–L637 |
| `_stop_pool` | def | L640–L647 |
| `run_auto_mission` | def | L651–L954 |
