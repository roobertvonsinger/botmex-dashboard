...
| `_maintenance_gate` | def | L242–L252 |
| `_no_cache_static_assets` | def | L256–L263 |
| `favicon` | def | L271–L272 |
| `login_page` | def | L276–L279 |
| `index` | def | L283–L296 |
| `auth_login` | def | L305–L330 |
| `auth_set_password` | def | L334–L358 |
| `auth_logout` | def | L362–L366 |
| `auth_me` | def | L370–L375 |
| `health` | def | L381–L387 |
| `list_accounts` | def | L391–L480 |
| `list_users` | def | L486–L494 |
| `list_assignments` | def | L498–L519 |
| `AssignRequest` | class | L522–L524 |
| `assign_accounts` | def | L528–L547 |
| `unassign_accounts` | def | L551–L562 |
| `stats` | def | L566–L573 |
| `_wsai_status` | def | L585–L610 |
| `_maybe_alert_broadcast` | def | L617–L634 |
| `_check_one_proxy` | def | L637–L662 |
| `_proxy_health` | def | L665–L710 |
| `_capmonster_balance` | def | L713–L733 |
| `_operator_color` | def | L738–L739 |
| `_resolve_who` | def | L742–L750 |
| `superadmin_kpis` | def | L754–L997 |
| `RefreshRequest` | class | L1002–L1003 |
| `accounts_refresh` | def | L1007–L1026 |
| `get_logs` | def | L1032–L1057 |
| `_run_health_checks` | def | L1065–L1101 |
| `health_full` | def | L1105–L1106 |
| `_require_sa` | def | L1114–L1116 |
| `admin_diag` | def | L1120–L1151 |
| `admin_ping` | def | L1155–L1176 |
| `admin_refresh_proxy` | def | L1180–L1187 |
| `admin_services_restart` | def | L1191–L1205 |
| `admin_export_logs` | def | L1209–L1221 |
| `admin_pause_state` | def | L1229–L1231 |
| `admin_pause` | def | L1235–L1247 |
| `admin_resume` | def | L1251–L1257 |
| `admin_emergency_stop` | def | L1261–L1296 |
| `admin_vps_reboot` | def | L1300–L1312 |
| `health_last` | def | L1316–L1317 |
| `health_dismiss` | def | L1321–L1324 |
| `_health_loop` | def | L1327–L1337 |
| `_run_lock_janitor` | def | L1340–L1398 |
| `_janitor_loop` | def | L1401–L1411 |
| `_run_window_watcher` | def | L1420–L1494 |
| `_window_watcher_loop` | def | L1497–L1506 |
| `_release_watchdog_tick` | def | L1509–L1625 |
| `_release_watchdog_loop` | def | L1628–L1636 |
| `_start_bg_tasks` | def | L1640–L1644 |
| `LockRequest` | class | L1647–L1649 |
| `lock_account` | def | L1653–L1681 |
| `PublishRequest` | class | L1684–L1686 |
| `publish_accounts` | def | L1690–L1705 |
| `hide_all_accounts` | def | L1709–L1720 |
| `pool_accounts` | def | L1724–L1742 |
| `unlock_account` | def | L1746–L1773 |
| `_sse_generator` | def | L1776–L1803 |
| `events` | def | L1807–L1812 |
| `account_cards_pipe` | def | L1816–L1841 |
| `account_notes_summary` | def | L1845–L1870 |
| `account_details` | def | L1874–L2085 |
| `NoteCreate` | class | L2088–L2089 |
| `create_note` | def | L2093–L2122 |
| `CurpUpdate` | class | L2125–L2126 |
| `update_curp` | def | L2130–L2141 |
| `delete_note` | def | L2145–L2157 |
| `CombosRequest` | class | L2160–L2161 |
| `accounts_combos` | def | L2165–L2174 |
| `accounts_pass_map` | def | L2178–L2182 |
| `list_all_cards` | def | L2186–L2256 |
| `activity_feed` | def | L2260–L2377 |
| `list_deposits` | def | L2381–L2406 |
| `deposits_stats` | def | L2410–L2435 |
