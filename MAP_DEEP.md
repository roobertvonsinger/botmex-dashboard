...
| `list_accounts` | def | L650–L749 |
| `list_users` | def | L755–L763 |
| `list_assignments` | def | L767–L788 |
| `AssignRequest` | class | L791–L793 |
| `assign_accounts` | def | L797–L816 |
| `unassign_accounts` | def | L820–L831 |
| `stats` | def | L835–L842 |
| `_wsai_status` | def | L857–L882 |
| `_maybe_alert_broadcast` | def | L889–L906 |
| `_check_one_proxy` | def | L909–L935 |
| `_proxy_health` | def | L938–L987 |
| `_capmonster_balance` | def | L990–L1010 |
| `_operator_color` | def | L1015–L1030 |
| `_resolve_who` | def | L1033–L1046 |
| `_event_visible_to` | def | L1049–L1075 |
| `superadmin_kpis` | def | L1079–L1322 |
| `RefreshRequest` | class | L1327–L1328 |
| `accounts_refresh` | def | L1332–L1351 |
| `get_logs` | def | L1357–L1382 |
| `_run_health_checks` | def | L1390–L1426 |
| `health_full` | def | L1430–L1431 |
| `_require_sa` | def | L1439–L1441 |
| `admin_diag` | def | L1445–L1476 |
| `admin_ping` | def | L1480–L1501 |
| `admin_refresh_proxy` | def | L1505–L1512 |
| `admin_services_restart` | def | L1516–L1530 |
| `admin_export_logs` | def | L1534–L1546 |
| `admin_pause_state` | def | L1554–L1556 |
| `admin_pause` | def | L1560–L1572 |
| `admin_resume` | def | L1576–L1582 |
| `admin_emergency_stop` | def | L1586–L1621 |
| `admin_vps_reboot` | def | L1625–L1637 |
| `health_last` | def | L1641–L1642 |
| `health_dismiss` | def | L1646–L1649 |
| `api_marks_list` | def | L1653–L1660 |
| `api_marks_toggle` | def | L1664–L1682 |
| `api_recent` | def | L1686–L1758 |
| `api_accounts_at_hand` | def | L1762–L1870 |
| `_health_loop` | def | L1873–L1883 |
| `_release_account` | def | L1886–L1907 |
| `_run_lock_janitor` | def | L1910–L1958 |
| `_janitor_loop` | def | L1961–L1971 |
| `_run_window_watcher` | def | L1980–L2052 |
| `_window_watcher_loop` | def | L2055–L2064 |
| `_release_watchdog_tick` | def | L2067–L2166 |
| `_release_watchdog_loop` | def | L2169–L2177 |
| `_jwt_keepalive_loop` | def | L2180–L2197 |
| `_start_bg_tasks` | def | L2201–L2206 |
| `LockRequest` | class | L2209–L2211 |
| `lock_account` | def | L2215–L2254 |
| `PublishRequest` | class | L2257–L2259 |
| `publish_accounts` | def | L2263–L2286 |
| `hide_all_accounts` | def | L2290–L2302 |
| `pool_accounts` | def | L2306–L2324 |
| `api_pool_split` | def | L2328–L2342 |
| `api_pool_publish` | def | L2346–L2378 |
| `unlock_account` | def | L2382–L2400 |
| `_sse_generator` | def | L2403–L2429 |
| `events` | def | L2433–L2443 |
| `account_cards_pipe` | def | L2447–L2473 |
| `account_notes_summary` | def | L2477–L2502 |
| `account_details` | def | L2506–L2807 |
| `NoteCreate` | class | L2810–L2811 |
| `create_note` | def | L2815–L2844 |
| `CurpUpdate` | class | L2847–L2848 |
| `update_curp` | def | L2852–L2863 |
| `delete_note` | def | L2867–L2879 |
| `CombosRequest` | class | L2882–L2883 |
| `accounts_combos` | def | L2887–L2900 |
| `accounts_pass_map` | def | L2904–L2909 |
| `list_all_cards` | def | L2913–L2988 |
| `activity_feed` | def | L2992–L3113 |
| `list_deposits` | def | L3117–L3146 |
| `deposits_stats` | def | L3150–L3175 |
