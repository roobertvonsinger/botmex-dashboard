...
| `_tail_log_file` | def | L1892–L1920 |
| `get_logs` | def | L1924–L1946 |
| `get_logs_telegram` | def | L1960–L2006 |
| `_run_health_checks` | def | L2014–L2050 |
| `health_full` | def | L2054–L2055 |
| `_require_sa` | def | L2063–L2065 |
| `admin_diag` | def | L2069–L2100 |
| `admin_ping` | def | L2104–L2125 |
| `admin_refresh_proxy` | def | L2129–L2136 |
| `admin_services_restart` | def | L2140–L2161 |
| `admin_export_logs` | def | L2165–L2181 |
| `admin_pause_state` | def | L2189–L2191 |
| `admin_pause` | def | L2195–L2207 |
| `admin_resume` | def | L2211–L2217 |
| `admin_emergency_stop` | def | L2221–L2256 |
| `admin_vps_reboot` | def | L2260–L2272 |
| `health_last` | def | L2276–L2277 |
| `health_dismiss` | def | L2281–L2284 |
| `api_marks_list` | def | L2288–L2295 |
| `api_marks_toggle` | def | L2299–L2317 |
| `api_recent` | def | L2321–L2393 |
| `api_accounts_at_hand` | def | L2397–L2505 |
| `_health_loop` | def | L2508–L2518 |
| `_release_account` | def | L2521–L2542 |
| `_run_lock_janitor` | def | L2545–L2593 |
| `_janitor_loop` | def | L2596–L2606 |
| `_run_window_watcher` | def | L2615–L2687 |
| `_window_watcher_loop` | def | L2690–L2699 |
| `_release_watchdog_tick` | def | L2702–L2801 |
| `_release_watchdog_loop` | def | L2804–L2812 |
| `_jwt_keepalive_loop` | def | L2815–L2843 |
| `_wake_jwt_keeper` | def | L2850–L2861 |
| `_account_refresh_loop` | def | L2864–L2882 |
| `_bot_token` | def | L2888–L2897 |
| `_notify_robert` | def | L2900–L2915 |
| `_startup_telegram_notify` | def | L2918–L2942 |
| `_lifespan` | def | L2946–L2958 |
| `LockRequest` | class | L2964–L2966 |
| `lock_account` | def | L2970–L3009 |
| `PublishRequest` | class | L3012–L3014 |
| `publish_accounts` | def | L3018–L3047 |
| `hide_all_accounts` | def | L3051–L3066 |
| `pool_accounts` | def | L3070–L3088 |
| `api_pool_split` | def | L3092–L3106 |
| `api_pool_publish` | def | L3110–L3137 |
| `unlock_account` | def | L3141–L3159 |
| `_sse_generator` | def | L3162–L3191 |
| `events` | def | L3195–L3205 |
| `account_cards_pipe` | def | L3209–L3235 |
| `account_notes_summary` | def | L3239–L3264 |
| `_record_account_touch` | def | L3267–L3300 |
| `account_find_id` | def | L3304–L3310 |
| `account_refresh_api` | def | L3314–L3419 |
| `account_details` | def | L3423–L3814 |
| `NoteCreate` | class | L3817–L3818 |
| `create_note` | def | L3822–L3851 |
| `CurpUpdate` | class | L3854–L3855 |
| `update_curp` | def | L3859–L3870 |
| `get_clabes` | def | L3880–L3889 |
| `refresh_clabes` | def | L3893–L3903 |
| `_persist_withdrawal` | def | L3912–L3958 |
| `withdraw` | def | L3962–L4014 |
| `withdraw_status` | def | L4018–L4081 |
| `delete_note` | def | L4085–L4097 |
| `CombosRequest` | class | L4100–L4101 |
| `accounts_combos` | def | L4105–L4118 |
| `accounts_pass_map` | def | L4122–L4127 |
| `list_all_cards` | def | L4131–L4207 |
| `activity_feed` | def | L4211–L4308 |
| `list_deposits` | def | L4312–L4341 |
| `deposits_stats` | def | L4345–L4370 |
| `_persist_auto_mission` | def | L4378–L4408 |
| `admin_maintenance_state` | def | L4412–L4415 |
| `MaintenanceToggleRequest` | class | L4418–L4419 |
| `admin_maintenance_toggle` | def | L4423–L4446 |
| `auto_deposit_create` | def | L4450–L4486 |
| `auto_deposit_cancel` | def | L4490–L4516 |
| `emergency_stop_all_deposits` | def | L4520–L4551 |
| `operator_my_accounts` | def | L4555–L4645 |
| `operator_release_account` | def | L4649–L4666 |
| `operator_withdraw` | def | L4670–L4728 |
| `operator_auto_withdraw` | def | L4732–L4768 |
| `auto_deposit_confirm` | def | L4772–L4791 |
| `operator_missions` | def | L4795–L4813 |
| `operator_recent_ticker` | def | L4817–L4942 |
| `auto_deposit_status` | def | L4946–L4957 |
| `register_operator_strike` | def | L4960–L4993 |
| `bot_start_info` | def | L4997–L5033 |
| `bot_operator_info` | def | L5037–L5076 |
| `bot_help_info` | def | L5080–L5094 |
| `bot_pause_mission` | def | L5098–L5127 |
| `bot_resume_mission` | def | L5131–L5149 |
| `bot_cancel_mission` | def | L5154–L5189 |
| `bot_bet_create` | def | L5193–L5363 |
| `filter_and_sanitize_check_combos` | def | L5366–L5451 |
| `BotCheckRequest` | class | L5454–L5458 |
| `bot_check` | def | L5461–L5542 |
