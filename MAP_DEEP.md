...
| `_drain_stale_tokens` | def | L84–L116 |
| `_ensure_fresh_captcha` | def | L119–L143 |
| `_record_bin_3ds` | def | L151–L179 |
| `_bin_3ds_stats` | def | L182–L204 |
| `bin_check` | def | L208–L213 |
| `bin_stats_overview` | def | L217–L262 |
| `_auto_lock_for_deposit` | def | L265–L316 |
| `_window_status` | def | L319–L361 |
| `_check_caps` | def | L364–L377 |
| `_load_deps` | def | L380–L391 |
| `_parse_pipe` | def | L394–L415 |
| `_check_card_velocity` | def | L435–L482 |
| `_record_attempt` | def | L485–L595 |
| `_safe_phase` | def | L605–L612 |
| `_build_admin_proxy_url` | def | L615–L619 |
| `_refresh_account_after_deposit` | def | L622–L669 |
| `_run_deposit_with_phases` | def | L672–L1149 |
| `deposit_execute_stream` | def | L1153–L1361 |
| `cap_status` | def | L1365–L1377 |
| `_mm_is_real_decline` | def | L1414–L1420 |
| `_mm_session_get` | def | L1455–L1459 |
| `_mm_session_update` | def | L1462–L1471 |
| `multi_stream` | def | L1475–L1902 |
| `multi_cancel` | def | L1906–L1911 |
| `scheduled_create` | def | L1924–L2247 |
| `scheduled_list` | def | L2251–L2273 |
| `scheduled_cancel` | def | L2277–L2285 |
